   ...
   Begin ActiveBar3LibraryCtl.ActiveBar3 BarMenu 
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Top             =   120
            Width           =   12135
            Begin VB.CheckBox cnkNonInviareEmail 
               Caption         =   "Non permettere invio email"
               Height          =   315
               Left            =   120
               TabIndex        =   28
               Top             =   840
            ...
            Begin VB.CheckBox chkAnullato 
               ...
               Width           =   1575
            End
            Begin VB.Frame FraLavoro 
               Caption         =   "Configurazione orari di lavoro"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
               ...
               Visible         =   0   'False
               Width           =   7455
               Begin DMTDATETIMELib.dmtTime txtOrarioInizio 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   17
                  Top             =   480
                  ...
                  Appearance      =   1
               End
               Begin DMTDATETIMELib.dmtTime txtOrarioFine 
                  Height          =   315
                  Left            =   1560
                  TabIndex        =   19
                  Top             =   480
                  ...
                  Appearance      =   1
               End
               Begin DMTDATETIMELib.dmtTime txtInizioPausa 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   21
                  Top             =   1080
                  ...
                  Appearance      =   1
               End
               Begin DMTDATETIMELib.dmtTime txtFinePausa 
                  Height          =   315
                  Left            =   1560
                  TabIndex        =   23
                  Top             =   1080
            ...
            Begin VB.Frame FraIntervento 
               Caption         =   "Configurazione predefiniti per intervento"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
               ...
               Begin DMTDataCmb.DMTCombo cboCategoriaIntervento 
                  ...
                  EndProperty
               End
               Begin DMTDataCmb.DMTCombo cboTipoAddebito 
                  Height          =   315
                  Left            =   2520
                  TabIndex        =   11
                  Top             =   600
                  ...
                  EndProperty
               End
               Begin DMTDataCmb.DMTCombo cboClasseIntervento 
                  Height          =   315
                  Left            =   4920
                  TabIndex        =   12
                  Top             =   600
               ...
               End
            End
            Begin DmtCodDescCtl.DmtCodDesc CDTecnicoOpeIntervento 
               Height          =   615
               Left            =   120
               TabIndex        =   0
               Top             =   120
               ...
               BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               PropDescrizione =   $"frmMain.frx":47A45
            ...
            End
            Begin DMTEDITNUMLib.dmtNumber txtCostoOrario 
               Height          =   315
               Left            =   4800
               TabIndex        =   25
               Top             =   370
...
If m_Document(m_Document.PrimaryKey).Value <= 0 Then
    If GET_ESISTENZA_UTENTE = True Then
        MsgBox "Tecnico operativo esistente", vbInformation, "Salvataggio dati"
...
Private Sub CreateFormFields()
    ...
    'IDAnagrafica del tecnico operativo
    Set Field = New FormField
    Set Field.Control = Me.CDTecnicoOpeIntervento
    Field.Name = "IDAnagrafica"
    Field.Visible = True
    Me.CDTecnicoOpeIntervento.Tag = Field.Name
    m_FormFields.Add Field

    'IDCategoriaIntervento
    Set Field = New FormField
    Set Field.Control = Me.cboCategoriaIntervento
    Field.Name = "IDRV_POCategoriaFase"
    Field.Visible = True
    Me.cboCategoriaIntervento.Tag = Field.Name
    m_FormFields.Add Field
    
    'IDTipoAddebitoIntervento
    Set Field = New FormField
    Set Field.Control = Me.cboTipoAddebito
    Field.Name = "IDRV_POTipoAddebito"
    Field.Visible = True
    Me.cboTipoAddebito.Tag = Field.Name
    m_FormFields.Add Field

    'IDTipoClasseIntervento
    Set Field = New FormField
    Set Field.Control = Me.cboClasseIntervento
    Field.Name = "IDRV_POTipoClasseIntervento"
    Field.Visible = True
    Me.cboClasseIntervento.Tag = Field.Name
    m_FormFields.Add Field

    'OraInizioGiornaliero
    Set Field = New FormField
    Set Field.Control = Me.txtOrarioInizio
    Field.Name = "OraInizioGiornaliero"
    Field.Visible = True
    Me.txtOrarioInizio.Tag = Field.Name
    m_FormFields.Add Field

    'OraFineGiornaliero
    Set Field = New FormField
    Set Field.Control = Me.txtOrarioFine
    Field.Name = "OraFineGiornaliero"
    Field.Visible = True
    Me.txtOrarioFine.Tag = Field.Name
    m_FormFields.Add Field

    'OraInizioPausa
    Set Field = New FormField
    Set Field.Control = Me.txtInizioPausa
    Field.Name = "OraInizioPausa"
    Field.Visible = True
    Me.txtInizioPausa.Tag = Field.Name
    m_FormFields.Add Field

    'OraFinePausa
    Set Field = New FormField
    Set Field.Control = Me.txtFinePausa
    Field.Name = "OraFinePausa"
    Field.Visible = True
    Me.txtFinePausa.Tag = Field.Name
    m_FormFields.Add Field

    'CostoOrario
    Set Field = New FormField
    Set Field.Control = Me.txtCostoOrario
    Field.Name = "CostoLavoro"
    Field.Visible = True
    Me.txtCostoOrario.Tag = Field.Name
    m_FormFields.Add Field
    
    'Annullato
    Set Field = New FormField
    Set Field.Control = Me.chkAnullato
    Field.Name = "Annullato"
    Field.Visible = True
    Me.chkAnullato.Tag = Field.Name
    m_FormFields.Add Field
    
    'NonInviareEmail
    Set Field = New FormField
    Set Field.Control = Me.cnkNonInviareEmail
    Field.Name = "NonInviareEmail"
    Field.Visible = True
    Me.cnkNonInviareEmail.Tag = Field.Name
    m_FormFields.Add Field
    
    'IDMagazzinoAssociato
    Set Field = New FormField
    Set Field.Control = Me.cboMagazzino
    Field.Name = "IDMagazzinoAssociato"
    Field.Visible = True
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Anagrafica", "Tecnico operativo", m_DocType.TableName, False, False, , dgCondTypeText)
        Cond.Indentation = 20
    Set Cond = BrwMain.Conditions.Add("Nome", "Nome Tecnico operativo", m_DocType.TableName, False, False, , dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("IDRV_POCategoriaFase", "Categoria", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.Indentation = 20
        Cond.RecordSource = "SELECT * FROM RV_POCategoriaFase ORDER BY CategoriaFase"
        Cond.DisplayField = "CategoriaFase"
        Cond.KeyField = "IDRV_POCategoriaFase"
    Set Cond = BrwMain.Conditions.Add("IDRV_POTipoAddebito", "Tipo addebito", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.Indentation = 20
        Cond.RecordSource = "SELECT * FROM RV_POTipoAddebito ORDER BY TipoAddebito"
        Cond.DisplayField = "TipoAddebito"
        Cond.KeyField = "IDRV_POTipoAddebito"
    Set Cond = BrwMain.Conditions.Add("IDRV_POTipoClasseIntervento", "Classe intervento", m_DocType.TableName, False, False, , dgCondTypeComboDB)
        Cond.Indentation = 20
        Cond.RecordSource = "SELECT * FROM RV_POTipoClasseIntervento ORDER BY TipoClasseIntervento"
        Cond.DisplayField = "TipoClasseIntervento"
        Cond.KeyField = "IDRV_POTipoClasseIntervento"
    Set Cond = BrwMain.Conditions.Add("Annullato", "Annullato", m_DocType.TableName, False, False, , dgCondTypeBoolean)
End Sub
'**+
'Nome: Export
'
...
Private Function fnFillDocTypeCondition() As String
    ...
    m_DocType.Fields("IDTIpoAnagrafica").Value = LINK_TIPO_ANA_TEC_FASE
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    With Me.CDTecnicoOpeIntervento
        Set .Application = m_App
    ...
    With Me.cboCategoriaIntervento
        ...
        .SQL = "SELECT * FROM RV_POCategoriaFase"
        .Fill
    End With

    'Tipo addebito
    With Me.cboTipoAddebito
        Set .Database = TheApp.Database.Connection
        .AddFieldKey "IDRV_POTipoAddebito"
        .DisplayField = "TipoAddebito"
        .SQL = "SELECT * FROM RV_POTipoAddebito ORDER BY TipoAddebito"
        .Fill
    End With

    'Tipo classe intervento
    With Me.cboClasseIntervento
        Set .Database = TheApp.Database.Connection
        .AddFieldKey "IDRV_POTipoClasseIntervento"
        .DisplayField = "TipoClasseIntervento"
        .SQL = "SELECT * FROM RV_POTipoClasseIntervento ORDER BY TipoClasseIntervento"
        .Fill
    End With
    ...
    With Me.cboMagazzino
        ...
        .SQL = "SELECT * FROM Magazzino WHERE IDFiliale=" & TheApp.Branch & " ORDER BY Magazzino"
        .Fill
    End With
End Sub
    ...
    For Each Field In m_Document.Fields
        ...
        If Not Field.PrimaryKey Then
            ...
            Else
                ...
                End If
                If Field.Name = "IDTipoAnagrafica" Then
                    Field.Value = LINK_TIPO_ANA_TEC_FASE
                End If
            End If
        End If
    Next
...
Private Sub cboCategoriaIntervento_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cboClasseIntervento_Click()
If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub cboTipoAddebito_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub CDTecnicoOpeIntervento_ChangeElement()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub chkAnullato_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cnkNonInviareEmail_Click()
    If Not (BrwMain.Visible) Then Change
End Sub
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
    ...
    'End If
    Me.cboMagazzino.Enabled = True
    If (MODULO_ATTIVATO = 0) Then Me.cboMagazzino.Enabled = False
...
Private Function GET_ESISTENZA_UTENTE() As Boolean
    ...
    sSQL = "SELECT IDAnagrafica FROM RV_POConfigurazioneTecnicoOpe"
    sSQL = sSQL & " WHERE IDAzienda=" & TheApp.IDFirm
    sSQL = sSQL & " AND IDAnagrafica=" & Me.CDTecnicoOpeIntervento.KeyFieldID
...
Private Sub txtCostoOrario_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtFinePausa_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtInizioPausa_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtOrarioFine_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtOrarioInizio_Change()
If Not (BrwMain.Visible) Then Change
End Sub
