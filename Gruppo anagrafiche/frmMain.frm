   ...
   Begin ActiveBar3LibraryCtl.ActiveBar3 BarMenu 
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Top             =   120
            Width           =   12375
            Begin VB.TextBox txtGruppoAnagrafica 
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               TabCaption(0)   =   "ANAGRAFICHE CLIENTE"
               TabPicture(0)   =   "frmMain.frx":04DA
               Tab(0).ControlEnabled=   -1  'True
               Tab(0).Control(0)=   "GrigliaArticolo"
               Tab(0).Control(0).Enabled=   0   'False
               Tab(0).Control(1)=   "cmdNuovo_Quadratura"
               Tab(0).Control(1).Enabled=   0   'False
               Tab(0).Control(2)=   "cmdSalva_Quadratura"
               Tab(0).Control(2).Enabled=   0   'False
               Tab(0).Control(3)=   "cmdElimina_Quadratura"
               ...
               Begin VB.CommandButton cmdNuovo_Quadratura 
                  ...
                  Width           =   1575
               End
               Begin DmtGridCtl.DmtGrid GrigliaArticolo 
                  Height          =   7215
                  Left            =   120
                  TabIndex        =   11
                  Top             =   360
...
Private Const CAMPO_PER_CAPTION = "GruppoAnagrafiche"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtGruppoAnagrafica
    Field.Name = "GruppoAnagrafiche"
    Field.Visible = True
    Me.txtGruppoAnagrafica.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("GruppoAnagrafiche", "Gruppo anagrafica", m_DocType.TableName, False, False, False, dgCondTypeText)
...
sSQL = "DELETE FROM RV_POGruppoAnagraficheRighe "
sSQL = sSQL & "WHERE IDRV_POGruppoAnagraficheRighe=" & fnNotNullN(Me.GrigliaArticolo.AllColumns("IDRV_POGruppoAnagraficheRighe").Value)
Cn.Execute sSQL


GET_GRIGLIA fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
On Error GoTo ERR_cmdNuovo_Quadratura_Click
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then
        MsgBox "Salvare il gruppo prima di procedere a questo comando", vbInformation, "Inserimento clienti"
        Exit Sub
    End If
    
    LINK_TESTA_GRUPPO = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
    
    frmTrovaCliente.Show vbModal
...
ERR_cmdNuovo_Quadratura_Click:
    MsgBox Err.Description, vbCritical, "cmdNuovo_Quadratura_Click"
End Sub
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
       On Error Resume Next
        ...
        'Set Me.GrigliaArticolo.Recordset = m_Document.DocumentsLinks.Item(m_DocumentsLink.TableName).Data
...
Private Sub txtGruppoAnagrafica_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub GET_GRIGLIA(IDGruppoAnagrafica As Long)
'On Error GoTo ERR_GET_GRIGLIA
Dim sSQL As String
Dim OLDCursor As Long
Dim cl As dgColumnHeader
    
sSQL = "SELECT * FROM RV_PO51IEAnagraficaGruppo "
sSQL = sSQL & " WHERE IDRV_POGruppoAnagrafiche=" & IDGruppoAnagrafica
...
sSQL = sSQL & " ORDER BY Anagrafica, Nome"
    ...
    With Me.GrigliaArticolo
        ...
        .ColumnsHeader.Clear
            ...
            .ColumnsHeader.Add "IDRV_POGruppoAnagraficheRighe", "IDRV_POGruppoAnagraficheRighe", dgInteger, False, 500, dgAlignleft, True, True, False
            .ColumnsHeader.Add "IDRV_POGruppoAnagrafiche", "IDRV_POGruppoAnagrafiche", dgInteger, False, 500, dgAlignleft, True, True, False
            ...
            .ColumnsHeader.Add "NomeProvincia", "Provincia", dgchar, False, 1800, dgAlignleft, True, True, False
            .ColumnsHeader.Add "Nazione", "Nazione", dgchar, False, 1800, dgAlignleft, True, True, False
            .ColumnsHeader.Add "PersonaFisica", "Persona Fisica", dgBoolean, False, 1800, dgAligncenter, True, True, False
            .ColumnsHeader.Add "Referente", "Referente", dgchar, False, 1800, dgAlignleft, True, True, False
            .ColumnsHeader.Add "EMailInterno", "EMail", dgchar, False, 1800, dgAlignleft, True, True, False
            .ColumnsHeader.Add "Telefono", "Telefono", dgchar, False, 1800, dgAlignleft, True, True, False
            .ColumnsHeader.Add "AltriTelefoni", "Altri Telefoni", dgchar, False, 1800, dgAlignleft, True, True, False
    ...
    CREA_TABELLA_TEMPORANEA IDGruppoAnagrafica
Exit Sub
ERR_GET_GRIGLIA:
    MsgBox Err.Description, vbCritical, "Reperimento dati"
    
End Sub
Private Sub CREA_TABELLA_TEMPORANEA(IDGruppo As Long)
On Error GoTo ERR_CREA_TABELLA_TEMPORANEA
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset


If Not (rsRighe Is Nothing) Then
    If rsRighe.State > 0 Then
        rsRighe.Close
    End If
    Set rsRighe = Nothing
...
rsRighe.CursorLocation = adUseClient

rsRighe.Fields.Append "IDAnagrafica", adInteger, , adFldIsNullable

rsRighe.Open , , adOpenKeyset, adLockBatchOptimistic

sSQL = "SELECT IDAnagrafica FROM RV_POGruppoAnagraficheRighe "
sSQL = sSQL & "WHERE IDRV_POGruppoAnagrafiche=" & IDGruppo

Set rs = Cn.OpenResultset(sSQL)

While Not rs.EOF
    rsRighe.AddNew
        rsRighe!IDAnagrafica = fnNotNullN(rs!IDAnagrafica)
    rsRighe.Update
rs.MoveNext
Wend
rs.CloseResultset
Set rs = Nothing
Exit Sub
ERR_CREA_TABELLA_TEMPORANEA:
    MsgBox Err.Description, vbCritical, "CREA_TABELLA_TEMPORANEA"
End Sub
