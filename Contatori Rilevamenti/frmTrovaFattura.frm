...
Begin VB.Form frmTrovaFattura 
   ...
   End
End
Attribute VB_Name = "frmTrovaFattura"
...
'On Error GoTo ERR_fnGrigliaTipoPagamento
    ...
    If Len(sTabellaTestata) > 0 Then
        ...
        sSQL = sSQL & " AND " & sTabellaTestata & ".Link_Nom_Anagrafica=" & LINK_CLIENTE_FATT_CONTRATTO
...
Private Sub GrigliaCorpo_DblClick()
    frmMain.txtIDOggettoCollegato.Value = Me.GrigliaCorpo.AllColumns("IDOggetto").Value
    frmMain.txtIDTipoOggettoCollegato.Value = Me.GrigliaCorpo.AllColumns("IDTipoOggetto").Value
