         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Begin VB.TextBox txtNota01 
                  ...
                  Width           =   7455
               End
               Begin DMTEDITNUMLib.dmtNumber txtTipoIntReport 
                  Height          =   315
                  Left            =   5520
                  TabIndex        =   2
                  Top             =   480
...
Private Const CAMPO_PER_CAPTION = "Oggetto"
...
Private Function PermissionToSave() As Boolean
    ...
    If Me.cboTipoOggetto.CurrentID = 0 Then
        MsgBox "Inserire il tipo oggetto", vbInformation, "Controlla dati"
        
        Exit Function
    End If
    
    If (GET_ESISTENZA_TIPO_OGGETTO(Me.cboTipoOggetto.CurrentID) = True) Then
    
         MsgBox "Configurazione esistente", vbInformation, "Controlla dati"
...
Private Sub CreateFormFields()
    ...
    'TipoModalitaReport
    Set Field = New FormField
    Set Field.Control = Me.txtTipoIntReport
    Field.Name = "TipoModalitaReport"
    Field.Visible = True
    Me.txtTipoIntReport.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione1
    Set Field = New FormField
    Set Field.Control = Me.txtNota01
    Field.Name = "Annotazione1"
    Field.Visible = True
    Me.txtNota01.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione2
    Set Field = New FormField
    Set Field.Control = Me.txtNota02
    Field.Name = "Annotazione2"
    Field.Visible = True
    Me.txtNota02.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione3
    Set Field = New FormField
    Set Field.Control = Me.txtNota03
    Field.Name = "Annotazione3"
    Field.Visible = True
    Me.txtNota03.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione4
    Set Field = New FormField
    Set Field.Control = Me.txtNota04
    Field.Name = "Annotazione4"
    Field.Visible = True
    Me.txtNota04.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione5
    Set Field = New FormField
    Set Field.Control = Me.txtNota05
    Field.Name = "Annotazione5"
    Field.Visible = True
    Me.txtNota05.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione6
    Set Field = New FormField
    Set Field.Control = Me.txtNota06
    Field.Name = "Annotazione6"
    Field.Visible = True
    Me.txtNota06.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione7
    Set Field = New FormField
    Set Field.Control = Me.txtNota07
    Field.Name = "Annotazione7"
    Field.Visible = True
    Me.txtNota07.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione8
    Set Field = New FormField
    Set Field.Control = Me.txtNota08
    Field.Name = "Annotazione8"
    Field.Visible = True
    Me.txtNota08.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione9
    Set Field = New FormField
    Set Field.Control = Me.txtNota09
    Field.Name = "Annotazione9"
    Field.Visible = True
    Me.txtNota09.Tag = Field.Name
    m_FormFields.Add Field

    'Annotazione10
    Set Field = New FormField
    Set Field.Control = Me.txtNota10
    Field.Name = "Annotazione10"
    Field.Visible = True
    Me.txtNota10.Tag = Field.Name
    m_FormFields.Add Field
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Oggetto", "Tipo oggetto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    With Me.cboTipoOggetto
        ...
        .SQL = "SELECT * FROM TipoOggetto ORDER BY Oggetto"
        .Fill
    End With
...
Private Sub txtNota01_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota02_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota03_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota04_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota05_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota06_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota07_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota08_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota09_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtNota10_Change()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtTipoIntReport_Change()
If Not (BrwMain.Visible) Then Change
End Sub


Private Function GET_ESISTENZA_TIPO_OGGETTO(idtipooggetto As Long) As Boolean
On Error GoTo ERR_GET_ESISTENZA_TIPO_OGGETTO
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_ESISTENZA_TIPO_OGGETTO = False

sSQL = "SELECT IDRV_PODescrizioniTipoOggetto FROM RV_PODescrizioniTipoOggetto "
sSQL = sSQL & "WHERE IDAzienda=" & TheApp.IDFirm
sSQL = sSQL & " AND IDTipoOggetto=" & idtipooggetto
sSQL = sSQL & " AND IDRV_PODescrizioniTipoOggetto<>" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    GET_ESISTENZA_TIPO_OGGETTO = True
End If
...
Exit Function
ERR_GET_ESISTENZA_TIPO_OGGETTO:
    MsgBox Err.Description, vbCritical, "GET_ESISTENZA_TIPO_OGGETTO"
End Function
