      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtProduttore 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "Produttore"
...
Private Function PermissionToSave() As Boolean
    ...
    If Len(Trim(Me.txtProduttore.Text)) = 0 Then
        MsgBox "Inserire il prodotture", vbCritical, "Controllo dati"
        Exit Function
    End If
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtProduttore
    Field.Name = "Produttore"
    Field.Visible = True
    Me.txtProduttore.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Produttore", "Produttore", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtProduttore_Change()
If Not (BrwMain.Visible) Then Change
...
sSQL = "SELECT IDRV_POProduttore FROM RV_POProduttore "
sSQL = sSQL & " WHERE Produttore=" & fnNormString(Me.txtProduttore.Text)
sSQL = sSQL & " AND IDRV_POProduttore<>" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
