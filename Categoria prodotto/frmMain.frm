      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtCategoriaProdotto 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "CategoriaProdotto"
...
Private Function PermissionToSave() As Boolean
    ...
    If Len(Trim(Me.txtCategoriaProdotto.Text)) = 0 Then
        MsgBox "Inserire la categoria del prodotto", vbCritical, "Controllo dati"
        Exit Function
    End If
    

    
    If GET_ESISTENZA_RECORD = True Then
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtCategoriaProdotto
    Field.Name = "CategoriaProdotto"
    Field.Visible = True
    Me.txtCategoriaProdotto.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("CategoriaProdotto", "Categoria prodotto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtCategoriaProdotto_Change()
If Not (BrwMain.Visible) Then Change

End Sub
Private Function GET_ESISTENZA_RECORD() As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT IDRV_POCategoriaProdotto FROM RV_POCategoriaProdotto "
sSQL = sSQL & " WHERE CategoriaProdotto=" & fnNormString(Me.txtCategoriaProdotto.Text)
sSQL = sSQL & " AND IDRV_POCategoriaProdotto<>" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)

Set rs = Cn.OpenResultset(sSQL)

If rs.EOF Then
    GET_ESISTENZA_RECORD = False
Else
    GET_ESISTENZA_RECORD = True
End If
