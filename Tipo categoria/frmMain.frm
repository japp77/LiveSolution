      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.CheckBox chkCategoriaPerFase 
                  Caption         =   "Categoria per fase intervento"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   12
                  Top             =   1320
                  ...
                  Width           =   4335
               End
               Begin VB.CheckBox chkCategoriaPerInt 
                  Caption         =   "Categoria per intervento"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   11
                  Top             =   960
                  ...
                  Width           =   4335
               End
               Begin VB.TextBox txtCategoriaFase 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "CategoriaFase"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtCategoriaFase
    Field.Name = "CategoriaFase"
    Field.Visible = True
    Me.txtCategoriaFase.Tag = Field.Name
    m_FormFields.Add Field
        
    'Categoria per intervento
    Set Field = New FormField
    Set Field.Control = Me.chkCategoriaPerInt
    Field.Name = "CategoriaPerIntervento"
    Field.Visible = True
    Me.chkCategoriaPerInt.Tag = Field.Name
    m_FormFields.Add Field
    
    'Categoria per fase
    Set Field = New FormField
    Set Field.Control = Me.chkCategoriaPerFase
    Field.Name = "CategoriaPerFase"
    Field.Visible = True
    Me.chkCategoriaPerFase.Tag = Field.Name
    m_FormFields.Add Field
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("CategoriaFase", "Categoria fase", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("CategoriaPerIntervento", "Categoria per intervento", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
    Set Cond = BrwMain.Conditions.Add("CategoriaPerFase", "Categoria per fase", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
...
End Sub
Private Sub chkCategoriaPerFase_Click()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub chkCategoriaPerInt_Click()
    If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub txtCategoriaFase_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub txtTipoDurataAssistenza_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
