      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtClasseIntervento 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "TipoClasseIntervento"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtClasseIntervento
    Field.Name = "TipoClasseIntervento"
    Field.Visible = True
    Me.txtClasseIntervento.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoClasseIntervento", "Classe intervento", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtClasseIntervento_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
