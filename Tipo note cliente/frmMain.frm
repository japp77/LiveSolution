...
Private Const CAMPO_PER_CAPTION = "TitoloNotaCliente"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTitolo
    Field.Name = "TitoloNotaCliente"
    Field.Visible = True
    Me.txtTitolo.Tag = Field.Name
    m_FormFields.Add Field
    
    'Dismesso
    Set Field = New FormField
    Set Field.Control = Me.chkDismesso
    Field.Name = "Dismesso"
    Field.Visible = True
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TitoloNotaCliente", "Titolo note fisse", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("Dismesso", "Dismesso", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
