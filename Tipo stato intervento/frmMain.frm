      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtTipoStatoInt 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "StatoIntervento"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoStatoInt
    Field.Name = "StatoIntervento"
    Field.Visible = True
    Me.txtTipoStatoInt.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("StatoIntervento", "Tipo stato intervento", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtTipoStatoInt_Change()
If Not (BrwMain.Visible) Then Change
End Sub
