   ...
   Begin ActiveBar3LibraryCtl.ActiveBar3 BarMenu 
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Top             =   120
            Width           =   18975
            Begin VB.CheckBox chkNoCalcoloPeriodo 
               Caption         =   "Non calcolare il periodo di fatturazione delle rate dei contratti a noleggio quando una riga non è presente il prodotto"
               Height          =   375
               Left            =   11160
               TabIndex        =   27
               Top             =   8040
               Width           =   7695
            End
            Begin VB.CheckBox chkArticoloPiuPeriodo 
               Caption         =   $"frmMain.frx":479EA
               Height          =   375
               Left            =   11160
               TabIndex        =   26
               Top             =   7560
               Width           =   7695
            End
            Begin VB.TextBox txtEsempioConstruzioneLotto 
               Appearance      =   0  'Flat
               Height          =   885
               Left            =   120
               Locked          =   -1  'True
            ...
            Begin VB.ListBox lstLegenda 
               ...
               Width           =   4815
            End
            Begin VB.ListBox LstLegendaCodici 
               Appearance      =   0  'Flat
               BackColor       =   &H00800000&
               ForeColor       =   &H0000FFFF&
               Height          =   6465
               ...
               Width           =   2895
            End
            Begin VB.CheckBox chkPagamentoAnticipato 
               Caption         =   "Pagamento anticipato"
               Height          =   255
               Left            =   5040
               TabIndex        =   6
               Top             =   360
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               TabCaption(0)   =   "Costruzione riga periodo della rata del contratto"
               TabPicture(0)   =   "frmMain.frx":47A88
               ...
               Tab(0).Control(3)=   "Griglia"
               Tab(0).Control(3).Enabled=   0   'False
               Tab(0).Control(4)=   "cboTipoStringa"
               Tab(0).Control(4).Enabled=   0   'False
               Tab(0).Control(5)=   "txtPosizione"
               Tab(0).Control(5).Enabled=   0   'False
               Tab(0).Control(6)=   "cmdNuovo"
               Tab(0).Control(6).Enabled=   0   'False
               Tab(0).Control(7)=   "cmdSalva"
               Tab(0).Control(7).Enabled=   0   'False
               Tab(0).Control(8)=   "cmdElimina"
               Tab(0).Control(8).Enabled=   0   'False
               Tab(0).Control(9)=   "txtStringaPers"
               Tab(0).Control(9).Enabled=   0   'False
               Tab(0).ControlCount=   10
               Begin VB.TextBox txtStringaPers 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   14
                  Top             =   1320
               ...
               Begin DMTEDITNUMLib.dmtNumber txtPosizione 
                  ...
                  Appearance      =   1
               End
               Begin DMTDataCmb.DMTCombo cboTipoStringa 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   16
                  Top             =   720
               ...
               Begin VB.Label Label1 
                  Caption         =   "Stringa personalizzata"
                  Height          =   255
                  Index           =   1
                  Left            =   120
                  TabIndex        =   20
            ...
            Begin VB.Label Label2 
               Caption         =   "Esempio di costruzione periodo"
               Height          =   255
               Left            =   120
               TabIndex        =   23
               Top             =   7440
...
Private NuovoDocumento As Integer
...
Private Function GetCaption4MenuBar(ByVal sToolName As String) As String
    ...
    Select Case sToolName
        ...
        Case "Mnu_New"
            sStr = gResource.GetMessage(MNU_NEW) & Chr$(9) & "CTRL + N"
            
        Case "Mnu_Save"
            If m_App.Language <> 1 Then
                sStr = gResource.GetMessage(MNU_SAVE) & Chr$(9) & "CTRL + S"
            Else
                sStr = gResource.GetMessage(MNU_SAVE) & Chr$(9) & "MAIUSC + F12"
            End If
        ...
        Case "Mnu_Print"
            If m_App.Language <> 1 Then
                sStr = gResource.GetMessage(MNU_PRINT) & "..." & Chr$(9) & "CTRL + P"
            Else
                sStr = gResource.GetMessage(MNU_PRINT) & "..." & Chr$(9) & "CTRL+MAIUSC+F12"
            End If
        ...
        Case "Mnu_Delete"
            sStr = gResource.GetMessage(MNU_DELETE) & Chr$(9) & "CANC"
            
        Case "Mnu_Clear"
            sStr = gResource.GetMessage(MNU_CLEAR)
    
        Case "Mnu_Cut"
            sStr = gResource.GetMessage(MNU_CUT) & Chr$(9) & "CTRL + X"
            
        Case "Mnu_Copy"
            sStr = gResource.GetMessage(MNU_COPY) & Chr$(9) & "CTRL + C"
            
        Case "Mnu_Paste"
            sStr = gResource.GetMessage(MNU_PASTE) & Chr$(9) & "CTRL + V"
            
        Case "Mnu_NewSearch"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_FIND) & Chr$(9) & "CTRL + T"
            
        Case "Mnu_ExecuteSearch"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_EXECUTE_SEARCH) & Chr$(9) & "CTRL + E"
            
        Case "Mnu_SearchPrevious"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_PREVIOUS_SEARCH) & Chr$(9) & "CTRL + P"
            
        Case "Mnu_SearchNext"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_NEXT_SEARCH) & Chr$(9) & "CTRL + S"
        ...
        Case "Mnu_FormView"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_FORM) & Chr$(9) & "CTRL + F"
            
        Case "Mnu_TableView"
            gResource.CustomStrings.Clear
            gResource.CustomStrings.Add m_DocType.Name, 1
            sStr = gResource.GetMessage(MNU_TABLE) & Chr$(9) & "CTRL + M"
            
        Case "Mnu_SearchFilter"
            sStr = "Mo&dalità filtri" & Chr$(9) & "CTRL + MAIUSC + T"
            
        Case "Mnu_Folders"
            sStr = "&Proprietà tipo documento"
        ...
        Case "Mnu_HelpOnLine"
            sStr = gResource.GetMessage(MNU_HELP) & Chr$(9) & "F1"
            
        Case "Mnu_Summary"
            sStr = gResource.GetMessage(MNU_FREE_SEARCH)
            
        Case "Mnu_FastHelp"
            sStr = gResource.GetMessage(MNU_FASTHELP) & Chr$(9) & "MAIUSC+F1"
            
        Case "Mnu_Arg"
            sStr = gResource.GetMessage(MNU_ARG) & Chr$(9) & "CTRL+F1"
            
        Case "Mnu_Web"
            sStr = gResource.GetMessage(MNU_WEB)
            
        Case "Mnu_Assistant"
            sStr = gResource.GetMessage(MNU_ASSISTANT)
            
        Case "Mnu_Info"
            sStr = gResource.GetMessage(MNU_INFO)
            
        Case "Mnu_Web1"
            sStr = gResource.GetMessage(MNU_ADDRESS1)
            
        Case "Mnu_ChoiceAssistant"
            sStr = gResource.GetMessage(MNU_SELECT_ASSISTANT)
                    
        Case "Mnu_ViewAssistant"
            sStr = gResource.GetMessage(MNU_SHOW_HIDE_ASSISTANT)
            
        Case "Mnu_ViewAnimation"
            sStr = gResource.GetMessage(MNU_SHOW_ANIMATION)
            
        Case "Mnu_RunApplication"
            sStr = gResource.GetMessage(MNU_EXE_GEST) & Chr$(9) & "CTRL + G"
        
        Case "Mnu_SearchObject"
            sStr = gResource.GetMessage(MNU_SEARCH) & Chr$(9) & "CTRL + R"
...
Private Function Caption2Display(Optional ByVal ReadFromGrid As Boolean) As String
    If Not m_Document.EOF And Not m_Document.BOF Then
        If Not ReadFromGrid Then
            'Caption2Display = m_App.Caption & ": " & fnNotNull(m_Document.Fields(CAMPO_PER_CAPTION).Value) '& " " & fnNotNull(m_Document.Fields("XXX").Value) & " - [" & fnNotNull(m_Document.Fields("YYY").Value) & "]"
            Caption2Display = m_App.Caption & ": " & fnNotNull(m_Document.Fields(CAMPO_PER_CAPTION).Value) ' & " " & fnNotNull(m_Document.Fields("Nome").Value)
        Else
            'Caption2Display = m_App.Caption & ": " & fnNotNull(BrwMain.AllColumns(CAMPO_PER_CAPTION).Value) '& " " & fnNotNull(BrwMain.AllColumns("XXX").Value) & " - [" & fnNotNull(BrwMain.AllColumns("YYY").Value) & "]"
            Caption2Display = m_App.Caption & ": " & fnNotNull(BrwMain.AllColumns(CAMPO_PER_CAPTION).Value) '& " " & fnNotNull(BrwMain.AllColumns("Nome").Value)
        End If
    Else
...
Private Sub CreateFormFields()
    ...
    Set Field = New FormField
    Set Field.Control = Me.chkPagamentoAnticipato
    Field.Name = "PagamentoAnticipato"
    Field.Visible = True
    Me.chkPagamentoAnticipato.Tag = Field.Name
    m_FormFields.Add Field
    
    'ArticoloPiuPeriodoFatturazione
    Set Field = New FormField
    Set Field.Control = Me.chkArticoloPiuPeriodo
    Field.Name = "ArticoloPiuPeriodoFatturazione"
    Field.Visible = True
    Me.chkArticoloPiuPeriodo.Tag = Field.Name
    m_FormFields.Add Field
 
    'NoCalcoloPeriodoFattSenzaProdotto
    Set Field = New FormField
    Set Field.Control = Me.chkNoCalcoloPeriodo
    Field.Name = "NoCalcoloPeriodoFattSenzaProdotto"
    Field.Visible = True
    Me.chkNoCalcoloPeriodo.Tag = Field.Name
    m_FormFields.Add Field
...
'************************************************************************************
    ...
    'RIGHE COSTRUZIONE PERIODO
    Set m_DocumentsLink = m_Document.AddDocumentsLink("RV_POStringaPeriodoRighe")
    
    'Impostazioni dell'oggetto DocumentsLink
    m_DocumentsLink.EnableRefreshLinks = True '<-- Abilita il refresh dei campi collegati
    m_DocumentsLink.PrimaryKey = "IDRV_POStringaPeriodoRighe" '<-- Specifica il campo chiave primaria
    
    
    'Crea un Link LEFT JOIN sul campo "RV_POTipoTrattenuta.IDRV_POTipoTrattenuta"
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POCampoPeriodo", "RV_POCampoPeriodo", ltLeft, "IDRV_POCampoPeriodo")
    NewLink.AddLinkColumn "RV_POCampoPeriodo.CampoPeriodo"
    
    m_DocumentsLink.AddOrderedColumn "Posizione", ocAscending
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.Griglia.ColumnsHeader.Count = 0 Then
        With Me.Griglia.ColumnsHeader
            .Add "IDRV_POStringaPeriodoRighe", "IDRV_POStringaPeriodoRighe", dgInteger, False, 500, dgAlignleft, True, True, False
            .Add "Posizione", "Posizione", dgInteger, True, 1000, 0, True, True, False
            .Add "CampoPeriodo", "Campo", dgchar, True, 2500, 0, True, True, False
            .Add "Testo", "Testo", dgchar, True, 2000, 0, True, True, False
        End With
    End If
...
'''''''''''''''''''''''''CONTROLLI STANDARD''''''''''''''''''''''''''''''''''''
    ...
    'Tipo stringa del periodo
    With Me.cboTipoStringa
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDRV_POCampoPeriodo"
        .DisplayField = "CampoPeriodo"
        .SQL = "SELECT * FROM RV_POCampoPeriodo ORDER BY CampoPeriodo"
        .Fill
    End With
...
End Sub
Private Sub cboTipoStringa_Click()
If Me.cboTipoStringa.CurrentID = 1 Then
    Me.txtStringaPers.Enabled = True
Else
    Me.txtStringaPers.Enabled = False
End If
End Sub

Private Sub chkArticoloPiuPeriodo_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub chkNoCalcoloPeriodo_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cmdElimina_Click()
    m_DocumentsLink.Delete
    Me.txtEsempioConstruzioneLotto.Text = Get_EsempioStringaLotto
...
Private Sub cmdNuovo_Click()
    ...
    Me.txtPosizione.Value = Get_NuovaPosizione
End Sub

Private Sub cmdSalva_Click()
Dim AggiornaPosizione As Boolean
...
If m_Document(m_Document.PrimaryKey).Value > 0 Then
    ...
    If fnEsistenzaPosizione(Me.txtPosizione.Value) = True Then
        If MsgBox("ATTENZIONE!!" & vbCrLf & "La posizione n° " & Me.txtPosizione.Value & " è esistente." & vbCrLf & "Sovrascrivere?", vbInformation + vbYesNo, "Creazione stringa periodo") = vbYes Then
            AggiornaPosizione = True
        Else
            
            Me.txtPosizione.SetFocus
            Exit Sub
        End If
    End If
    
    m_DocumentsLink("IDRV_POCampoPeriodo") = Me.cboTipoStringa.CurrentID
    m_DocumentsLink("Posizione") = Me.txtPosizione.Value
    m_DocumentsLink("Testo") = Me.txtStringaPers.Text
    m_DocumentsLink("Tipo") = 1
    
    m_DocumentsLink.Save

    
    If AggiornaPosizione = True Then
        fnAggiornaPosizioni Me.txtPosizione.Value, fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value)
    End If
...
Else
    MsgBox "Consolidare il documento prima della configurazione della stringa del periodo", vbInformation, "Costruzione stringa lotti"
End If
Exit Sub
ERR_cmdSalva_Click:
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
    ...
    End If
    m_DocumentsLink.AddCondition "Tipo=1"
...
Private Sub m_DocumentsLink_OnReposition()
    ...
    If Not (m_DocumentsLink.BOF And m_DocumentsLink.EOF) Then
        ...
        Me.cboTipoStringa.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POCampoPeriodo").Value)
        Me.txtPosizione.Value = fnNotNullN(m_DocumentsLink("Posizione").Value)
        Me.txtStringaPers.Text = fnNotNull(m_DocumentsLink("Testo").Value)
    ...
    Me.cboTipoStringa.Enabled = bValue
...
Private Function EsistenzaFiliale() As Boolean
    ...
    sSQL = "SELECT IDFiliale FROM RV_POStringaPeriodoTesta WHERE "
    sSQL = sSQL & "(IDFiliale=" & Me.cboFiliale.CurrentID & ") "
...
Private Function Get_EsempioStringaLotto() As String
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
Dim ParzialeDB As String
Get_EsempioStringaLotto = ""

sSQL = "SELECT RV_POStringaPeriodoRighe.IDRV_POCampoPeriodo, RV_POStringaPeriodoRighe.Testo, RV_POStringaPeriodoRighe.Posizione, "
sSQL = sSQL & "RV_POCampoPeriodo.CampoPeriodo , RV_POCampoPeriodo.StringaEsempio, RV_POStringaPeriodoRighe.Tipo "
sSQL = sSQL & " FROM RV_POStringaPeriodoTesta INNER JOIN "
sSQL = sSQL & "RV_POStringaPeriodoRighe ON "
sSQL = sSQL & "RV_POStringaPeriodoTesta.IDRV_POStringaPeriodoTesta = RV_POStringaPeriodoRighe.IDRV_POStringaPeriodoTesta INNER JOIN "
sSQL = sSQL & "RV_POCampoPeriodo ON RV_POStringaPeriodoRighe.IDRV_POCampoPeriodo = RV_POCampoPeriodo.IDRV_POCampoPeriodo "
sSQL = sSQL & "WHERE IDFiliale=" & Me.cboFiliale.CurrentID
sSQL = sSQL & " AND RV_POStringaPeriodoRighe.Tipo=1 "
sSQL = sSQL & " ORDER BY RV_POStringaPeriodoRighe.Posizione"
...
While Not rs.EOF
    Select Case rs!IDRV_POCampoPeriodo
        Case 1
            Get_EsempioStringaLotto = Get_EsempioStringaLotto & fnNotNull(rs!Testo)
        Case 13
            Get_EsempioStringaLotto = Get_EsempioStringaLotto & " "
        Case 14
            Get_EsempioStringaLotto = Get_EsempioStringaLotto & vbCrLf
        Case Else
            Get_EsempioStringaLotto = Get_EsempioStringaLotto & fnNotNull(rs!StringaEsempio)
    End Select
rs.MoveNext
Wend
rs.CloseResultset
...
Private Function Get_NuovaPosizione() As Integer
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT RV_POStringaPeriodoRighe.Posizione "
sSQL = sSQL & "FROM RV_POStringaPeriodoTesta INNER JOIN "
sSQL = sSQL & "RV_POStringaPeriodoRighe ON "
sSQL = sSQL & "RV_POStringaPeriodoTesta.IDRV_POStringaPeriodoTesta = RV_POStringaPeriodoRighe.IDRV_POStringaPeriodoTesta "
sSQL = sSQL & "WHERE IDFiliale=" & m_App.Branch
sSQL = sSQL & " AND Tipo=2"
sSQL = sSQL & " ORDER BY RV_POStringaPeriodoRighe.Posizione DESC "

Set rs = Cn.OpenResultset(sSQL)
If rs.EOF Then
    Get_NuovaPosizione = 1
Else
    Get_NuovaPosizione = fnNotNullN(rs!Posizione) + 1
End If
...
End Function
Private Function fnEsistenzaPosizione(Posizione As Integer) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
If m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value > 0 Then
    sSQL = sSQL & " AND IDRV_POStringaPeriodoRighe<>" & m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value
End If

Set rs = Cn.OpenResultset(sSQL)
If rs.EOF Then
    fnEsistenzaPosizione = False
Else
    fnEsistenzaPosizione = True
End If
...
End Function
Private Sub fnAggiornaPosizioni(Posizione As Integer, IDRiga As Long)
Dim sSQL As String
Dim rs As ADODB.Recordset
Dim I As Integer

sSQL = "SELECT RV_POStringaPeriodoRighe.*, RV_POStringaPeriodoTesta.IDFiliale  "
sSQL = sSQL & "FROM RV_POStringaPeriodoTesta INNER JOIN "
sSQL = sSQL & "RV_POStringaPeriodoRighe ON "
sSQL = sSQL & "RV_POStringaPeriodoTesta.IDRV_POStringaPeriodoTesta = RV_POStringaPeriodoRighe.IDRV_POStringaPeriodoTesta "
sSQL = sSQL & "WHERE IDFiliale=" & Me.cboFiliale.CurrentID
sSQL = sSQL & " AND Posizione>=" & Posizione
sSQL = sSQL & " AND IDRV_POStringaPeriodoRighe<>" & IDRiga
...
While Not rs.EOF
    If I = 0 Then
        If rs!Posizione <> Posizione Then
            rs.MoveLast
        Else
            I = I + 1
        End If
    ...
    End If
    If I > 0 Then
        'sSQL = "UPDATE RV_POStringaPeriodoRighe SET "
        'sSQL = sSQL & "Posizione=" & fnNotNullN(rs!Posizione) + 1
        'sSQL = sSQL & " WHERE IDRV_POStringaPeriodoRighe=" & fnNotNullN(rs!IDRV_POStringaPeriodoRighe)
        'Cn.Execute sSQL
...
End Sub
Private Sub fncLegenda()
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT * FROM RV_POCampoPeriodo "
sSQL = sSQL & "WHERE Contratto=1"
Set rs = Cn.OpenResultset(sSQL)
Me.lstLegenda.Clear
Me.LstLegendaCodici.Clear
While Not rs.EOF
    Me.lstLegenda.AddItem fnNotNull(rs!CampoPeriodo)
    Me.LstLegendaCodici.AddItem fnNotNull(rs!StringaEsempio)
rs.MoveNext
Wend
rs.CloseResultset
Set rs = Nothing
