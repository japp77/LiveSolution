...
'1=lotto conferimento ; 2=lotto vendita
Public TipoLotto As Integer
'1=Codice ; 2=Descrizione
Public TipoStringaLotto As Integer
'Variabile che indica l'ID del lotto
Public Const Link_Lotto As String = "XXXXXXXX"

Public LunghezzaCampo As Integer
Public LunghezzaStringaLotto As Integer
Public Const LunghezzaTotaleLotto As Integer = 32
