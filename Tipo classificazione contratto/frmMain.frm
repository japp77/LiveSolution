      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8055
               Begin VB.TextBox txtClassContratto 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
               ...
               Begin VB.Label Label1 
                  Caption         =   "Tipo classificazione contratto"
                  Height          =   255
                  Index           =   0
                  Left            =   120
                  TabIndex        =   8
...
Private Const CAMPO_PER_CAPTION = "TipoClassificazioneContratto"
...
Private Sub CreateFormFields()
    ...
    'RV_POTipoClassificazioneContratto
    Set Field = New FormField
    Set Field.Control = Me.txtClassContratto
    Field.Name = "TipoClassificazioneContratto"
    Field.Visible = True
    Me.txtClassContratto.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoClassificazioneContratto", "Tipo classificazione contratto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtClassContratto_Change()
