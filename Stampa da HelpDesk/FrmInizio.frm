...
'    End If
'
'    ConnessioneADODBLib TheApp.User, TheApp.Password
...
On Error GoTo ERR_ConfigurazioneStampe
...
Exit Sub
ERR_ConfigurazioneStampe:
    MsgBox Err.Description, vbCritical, "ConfigurazioneStampe"
    MsgBox CnDMT.InternalConnection
    MsgBox LINK_AZIENDA
End Sub
...
Private Sub Get_Chiavi_Registry()
    ...
    IDTipoOggettoReg = GetSetting(gResource.GetMessage(LBL_REGISTRY_KEY), App.EXEName, "IDTipoOggettoHD", 0)
    FunzioneReg = GetSetting(gResource.GetMessage(LBL_REGISTRY_KEY), App.EXEName, "FunzioneHD", "")
