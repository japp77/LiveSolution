...
Private Const CAMPO_PER_CAPTION = "TipoCliente"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoCliente
    Field.Name = "TipoCliente"
    Field.Visible = True
    Me.txtTipoCliente.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoCliente", "Tipo cliente", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtTipoCliente_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
