      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   7935
               Begin VB.CheckBox chkDueRate 
                  Caption         =   "Genera due rate"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   8
                  Top             =   3120
               ...
               Begin VB.CommandButton Command1 
                  Caption         =   "Dettaglio rateizzazione"
                  BeginProperty Font 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                  ...
                  Width           =   3135
               End
               Begin VB.CheckBox chkOgniNumeroRate 
                  Caption         =   "Considera il numero rate come la quantità periodo inserita nel prodotto nel contratto"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   4
                  Top             =   1680
                  Width           =   7695
               End
               Begin VB.CheckBox chkAnnoSolare 
                  Caption         =   "Calcola rate nel periodo nell'anno solare"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   7
                  Top             =   2760
                  Width           =   4215
               End
               Begin VB.CheckBox chkRataIniziale 
                  Caption         =   "Calcola rateo iniziale del primo mese"
                  Enabled         =   0   'False
                  Height          =   255
                  Left            =   120
                  TabIndex        =   6
                  ...
                  Width           =   3975
               End
               Begin VB.CheckBox chkFinePeriodo 
                  Caption         =   "Pagamento inizio periodo"
                  Height          =   255
                  Left            =   120
                  TabIndex        =   5
                  Top             =   2040
                  Width           =   2775
               End
               Begin VB.TextBox txtTipoRateizzione 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
                  Width           =   7695
               End
               Begin DMTEDITNUMLib.dmtNumber txtNumeroRate 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   1
                  Top             =   1200
               ...
               Begin DMTEDITNUMLib.dmtNumber txtMesi 
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtPercPrimaRata 
                  Height          =   285
                  Left            =   2760
                  TabIndex        =   3
                  Top             =   1200
               ...
               End
               Begin VB.Label Label1 
                  Caption         =   "Descrizione rateizzazione"
                  Height          =   255
                  Index           =   0
                  Left            =   120
                  TabIndex        =   15
...
Private Const CAMPO_PER_CAPTION = "Rateizzazione"
        ...
        For Each Field In m_FormFields
            ...
            Select Case TypeName(Field.Control)
                ...
                Case "Town"
                    ...
                    End If
                Case "dmtDate"
                    Field.Control.Value = fnNormDate(m_Document.Fields(Field.Name).Value)
                Case "dmtNumber"
                ...
                Case "DmtCodDesc"
                    Field.Control.Load m_Document.Fields(Field.Name).Value
                Case "CheckBox"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoRateizzione
    Field.Name = "Rateizzazione"
    Field.Visible = True
    Me.txtTipoRateizzione.Tag = Field.Name
    ...
    'NumeroRate
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroRate
    Field.Name = "NumeroRate"
    Field.Visible = True
    Me.txtNumeroRate.Tag = Field.Name
    m_FormFields.Add Field

    'Pagamento fine periodo
    Set Field = New FormField
    Set Field.Control = Me.chkFinePeriodo
    Field.Name = "PagamentoInizioPeriodo"
    Field.Visible = True
    Me.chkFinePeriodo.Tag = Field.Name
    m_FormFields.Add Field

    'RataInizialeRataFinale
    Set Field = New FormField
    Set Field.Control = Me.chkRataIniziale
    Field.Name = "RataInizialeRataFinale"
    Field.Visible = True
    Me.chkRataIniziale.Tag = Field.Name
    m_FormFields.Add Field

    'AnnoSolare
    Set Field = New FormField
    Set Field.Control = Me.chkAnnoSolare
    Field.Name = "AnnoSolare"
    Field.Visible = True
    Me.chkAnnoSolare.Tag = Field.Name
    m_FormFields.Add Field
    
    'ConsideraQuantitaPeriodo
    Set Field = New FormField
    Set Field.Control = Me.chkOgniNumeroRate
    Field.Name = "ConsideraQuantitaPeriodo"
    Field.Visible = True
    Me.chkOgniNumeroRate.Tag = Field.Name
    m_FormFields.Add Field
    
    'DueRate
    Set Field = New FormField
    Set Field.Control = Me.chkDueRate
    Field.Name = "DueRate"
    Field.Visible = True
    Me.chkDueRate.Tag = Field.Name
    m_FormFields.Add Field

    'PercentualePrimaRata
    Set Field = New FormField
    Set Field.Control = Me.txtPercPrimaRata
    Field.Name = "PercentualePrimaRata"
    Field.Visible = True
    Me.txtPercPrimaRata.Tag = Field.Name
    m_FormFields.Add Field
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Rateizzazione", "Tipo rateizzazione", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("NumeroRate", "Numero rate", m_DocType.TableName, False, False, False, dgCondTypeNumber)
    Set Cond = BrwMain.Conditions.Add("Mesi", "Ogni n. mesi", m_DocType.TableName, False, False, False, dgCondTypeNumber)
    
    Set Cond = BrwMain.Conditions.Add("PagamentoInizioPeriodo", "Fine periodo", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
    Set Cond = BrwMain.Conditions.Add("RataInizialeRataFinale", "Rateo iniziale", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
    Set Cond = BrwMain.Conditions.Add("AnnoSolare", "Rate nell'anno solare", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
...
Dim testo As String
    ...
    If fnMsgQuestion(gResource.GetCustomizedMessage(MESS_QUERYREMOVE), m_App.FunctionName) = vbYes Then
        ...
        'rif16
        LINK_RATEIZZAZIONE = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
        
        If GET_CONTROLLO_ESISTENZA_ID(LINK_RATEIZZAZIONE) = True Then
            testo = "È presente uno o più collegamenti con il contratto, pertanto è impossibile eliminare"
...
Private Sub chkAnnoSolare_Click()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub chkDueRate_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub chkFinePeriodo_Click()
    If Not (BrwMain.Visible) Then Change
End Sub
...
Private Sub chkOgniNumeroRate_Click()
    If Not (BrwMain.Visible) Then Change
    
End Sub

Private Sub chkRataIniziale_Click()
    If Not (BrwMain.Visible) Then Change
...
'            End If
    ...
    If Me.txtMesi.Value = 1 Then
        Me.chkRataIniziale.Enabled = True
    Else
        Me.chkRataIniziale.Value = vbUnchecked
        Me.chkRataIniziale.Enabled = False
    End If
...
Private Sub txtNumeroRate_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtPercPrimaRata_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtTipoRateizzione_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
End Sub
Private Sub LOAD_COLUMN_BRWMAIN()
...
Dim cl As dgColumnHeader
    ...
    With Me.BrwMain
        ...
        .ColumnsHeader.Clear
            ...
            .ColumnsHeader.Add "IDRV_PORateizzazione", "IDRV_PORateizzazione", dgInteger, False, 500, dgAlignRight
            .ColumnsHeader.Add "Rateizzazione", "Tipo", dgchar, True, 4500, dgAlignleft
            .ColumnsHeader.Add "PagamentoInizioPeriodo", "Pagamento inizio periodo", dgBoolean, True, 1000, dgAligncenter
            .ColumnsHeader.Add "RataInizialeRataFinale", "Calcola rateo iniziale", dgBoolean, True, 1000, dgAligncenter
            .ColumnsHeader.Add "AnnoSolare", "Calcola rate nell'anno solare", dgBoolean, True, 1000, dgAligncenter
...
Private Function GET_CONTROLLO_ESISTENZA_ID(ID As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_CONTROLLO_ESISTENZA_ID = False

'CONTROLLO ESISTENZA COLLEGAMENTO SU CONTRATTI
sSQL = "SELECT IDRV_POContratto FROM RV_POContratto "
sSQL = sSQL & "WHERE IDRateizzazione=" & ID

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    GET_CONTROLLO_ESISTENZA_ID = True
End If

rs.CloseResultset
Set rs = Nothing

If GET_CONTROLLO_ESISTENZA_ID = True Then Exit Function

'CONTROLLO ESISTENZA COLLEGAMENTO SUI PRODOTTI INSERITI NEI CONTRATTI
