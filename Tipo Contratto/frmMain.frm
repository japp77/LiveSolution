   ...
   Begin ActiveBar3LibraryCtl.ActiveBar3 BarMenu 
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Top             =   120
            Width           =   18960
            Begin VB.CommandButton cmdCondizioniGenerali 
               Height          =   315
               Left            =   6360
               Picture         =   "frmMain.frx":479EA
               Style           =   1  'Graphical
               TabIndex        =   63
               ToolTipText     =   "CONDIZIONI GENERALI"
               Top             =   480
               Width           =   375
            End
            Begin VB.CheckBox chkFestivo 
               Caption         =   "Festivo"
               Height          =   255
               Left            =   14160
               TabIndex        =   6
               ...
               Width           =   975
            End
            Begin VB.TextBox txtDescrizioneAggiuntiva 
               Height          =   735
               Left            =   120
               MultiLine       =   -1  'True
            ...
            Begin DmtCodDescCtl.DmtCodDesc CDArticolo 
               ...
               BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               PropDescrizione =   $"frmMain.frx":47FD4
               BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               MenuFunctions   =   $"frmMain.frx":4803B
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               TabPicture(0)   =   "frmMain.frx":48095
               ...
               Tab(0).Control(12)=   "Line3"
               Tab(0).Control(12).Enabled=   0   'False
               Tab(0).Control(13)=   "Line4"
               Tab(0).Control(13).Enabled=   0   'False
               Tab(0).Control(14)=   "Label1(17)"
               Tab(0).Control(14).Enabled=   0   'False
               Tab(0).Control(15)=   "Label1(33)"
               Tab(0).Control(15).Enabled=   0   'False
               Tab(0).Control(16)=   "cboTipoAnnoFineRicorr"
               Tab(0).Control(16).Enabled=   0   'False
               Tab(0).Control(17)=   "cboTipoAnnoInizioRicorr"
               Tab(0).Control(17).Enabled=   0   'False
               Tab(0).Control(18)=   "txtNumeroRicorrenze"
               Tab(0).Control(18).Enabled=   0   'False
               Tab(0).Control(19)=   "txtMeseFissoFineRic"
               Tab(0).Control(19).Enabled=   0   'False
               Tab(0).Control(20)=   "txtGiornoFissoFineRic"
               Tab(0).Control(20).Enabled=   0   'False
               Tab(0).Control(21)=   "cboTipoDataFineRic"
               Tab(0).Control(21).Enabled=   0   'False
               Tab(0).Control(22)=   "txtMeseFissoInizioRic"
               Tab(0).Control(22).Enabled=   0   'False
               Tab(0).Control(23)=   "txtGiornoFissoInizioRic"
               Tab(0).Control(23).Enabled=   0   'False
               Tab(0).Control(24)=   "cboTipoDataInizioRic"
               Tab(0).Control(24).Enabled=   0   'False
               Tab(0).Control(25)=   "txtOgniNumeroSettimane"
               Tab(0).Control(25).Enabled=   0   'False
               Tab(0).Control(26)=   "txtOgniNumeroMesi"
               Tab(0).Control(26).Enabled=   0   'False
               Tab(0).Control(27)=   "cboCriterioRicorrenza"
               Tab(0).Control(27).Enabled=   0   'False
               Tab(0).Control(28)=   "txtOgniNumeroGiorni"
               Tab(0).Control(28).Enabled=   0   'False
               Tab(0).Control(29)=   "CDServizio"
               Tab(0).Control(29).Enabled=   0   'False
               Tab(0).Control(30)=   "GrigliaServizi"
               Tab(0).Control(30).Enabled=   0   'False
               Tab(0).Control(31)=   "cmdEliminaServizio"
               Tab(0).Control(31).Enabled=   0   'False
               Tab(0).Control(32)=   "cmdSalvaServizio"
               Tab(0).Control(32).Enabled=   0   'False
               Tab(0).Control(33)=   "cmdNuovoServizio"
               Tab(0).Control(33).Enabled=   0   'False
               Tab(0).ControlCount=   34
               TabCaption(1)   =   "ECCEZIONI"
               TabPicture(1)   =   "frmMain.frx":480B1
               Tab(1).ControlEnabled=   0   'False
               Tab(1).Control(0)=   "Label18"
               Tab(1).Control(1)=   "Label16(0)"
               Tab(1).Control(2)=   "Label15(0)"
               ...
               Tab(1).Control(9)=   "txtDataFineEcc"
               Tab(1).Control(10)=   "txtTicketEcc"
               Tab(1).Control(11)=   "txtScontoEcc2"
               Tab(1).Control(12)=   "txtScontoEcc1"
               Tab(1).Control(13)=   "CDArticoloEcc"
               Tab(1).Control(14)=   "GrigliaEccezioni"
               Tab(1).Control(15)=   "cboTipoEccezione"
               Tab(1).Control(16)=   "txtImportoEccezione"
               Tab(1).Control(17)=   "txtDataInizioEcc"
               Tab(1).Control(18)=   "cboTipoImportoEcc"
               Tab(1).Control(19)=   "txtAnnotazioniEcc"
               Tab(1).Control(20)=   "cmdNuovoEcc"
               Tab(1).Control(21)=   "cmdSalvaEcc"
               Tab(1).Control(22)=   "cmdEliminaEcc"
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDServizio 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":4811C
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":48173
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDArticoloEcc 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":4821C
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":48273
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
            ...
            Begin DMTDataCmb.DMTCombo cboIva 
               ...
               EndProperty
            End
            Begin VB.Label lblPianoDeiConti 
...
Private Const CAMPO_PER_CAPTION = "TipoContratto"
...
Private Link_ContoPDC As Long
Private oPDC As DmtPDC.PDCServices
...
Private Function PermissionToSave() As Boolean
    ...
    If Len(Trim(Me.txtTipoContratto.Text)) = 0 Then
        MsgBox "Inserire il tipo di contratto", vbCritical, TheApp.FunctionName
        Exit Function
    End If
    
    If Me.CDArticolo.KeyFieldID = 0 Then
        MsgBox "Inserire l'articolo di fatturazione", vbCritical, TheApp.FunctionName
        Exit Function
    End If
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoContratto
    Field.Name = "TipoContratto"
    Field.Visible = True
    Me.txtTipoContratto.Tag = Field.Name
    m_FormFields.Add Field
    
    'IDIva
    Set Field = New FormField
    Set Field.Control = Me.cboIva
    Field.Name = "IDIva"
    Field.Visible = True
    Me.cboIva.Tag = Field.Name
    m_FormFields.Add Field
    
    'CodicePDC
    Set Field = New FormField
    Set Field.Control = Me.txtCodiceConto
    Field.Name = "CodicePDC"
    Field.Visible = True
    ...
    Set Field = New FormField
    Set Field.Control = Me.txtDescrizioneAggiuntiva
    Field.Name = "DescrizioneAggiuntiva"
    Field.Visible = True
    Me.txtDescrizioneAggiuntiva.Tag = Field.Name
    m_FormFields.Add Field
    ...
    m_FormFields.Add Field
     ...
     'Festivo
    Set Field = New FormField
    Set Field.Control = Me.chkFestivo
    Field.Name = "TipoContrattoFestivo"
    Field.Visible = True
    Me.chkFestivo.Tag = Field.Name
    m_FormFields.Add Field
...
'**************************SOTTO DOCUMENTO*******************************
    ...
    Set m_DocumentsLink = m_Document.AddDocumentsLink("RV_POTipoContrattoServizi")
    
    'Impostazioni dell'oggetto DocumentsLink
    m_DocumentsLink.EnableRefreshLinks = True '<-- Abilita il refresh dei campi collegati
    m_DocumentsLink.PrimaryKey = "IDRV_POTipoContrattoServizi" '<-- Specifica il campo chiave primaria
    ...
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POCriterioRicorrenza", "RV_POCriterioRicorrenza", ltLeft, "IDRV_POCriterioRicorrenza")
    ...
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POTipoDataInizioRicorrenza", "RV_POTipoDataInizioRicorrenza", ltLeft, "IDRV_POTipoDataInizioRicorrenza")
    ...
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POTipoDataFineRicorrenza", "RV_POTipoDataFineRicorrenza", ltLeft, "IDRV_POTipoDataFineRicorrenza")
    ...
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POTipoAnnoInizioRicorrenza", "RV_POTipoAnno", ltLeft, "IDRV_POTipoAnno")
    ...
    Set NewLink = m_DocumentsLink.AddLink("IDRV_POTipoAnnoFineRicorrenza", "RV_POIE_TipoAnno", ltLeft, "IDRV_POTipoAnno")
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoContratto", "Tipo contratto", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("CodicePDC", "Codice piano dei conti", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("DescrizionePDC", "Descrizione piano dei conti", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("CodiceArticolo", "Codice articolo", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("TipoContrattoFestivo", "Festivo", m_DocType.TableName, False, False, False, dgCondTypeBoolean)
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    If Me.GrigliaEccezioni.ColumnsHeader.Count = 0 Then
        With Me.GrigliaEccezioni.ColumnsHeader
            ...
            .Add "IDRV_POTipoContratto", "IDRV_POTipoContratto", dgInteger, False, 500, dgAlignRight
    ...
    If Me.GrigliaServizi.ColumnsHeader.Count = 0 Then
        With Me.GrigliaServizi.ColumnsHeader
            .Add "IDRV_POTipoContrattoServizi", "IDRV_POTipoContrattoServizi", dgInteger, False, 500, 0, True, True, False
            .Add "IDRV_POTipoContratto", "IDRV_POTipoContratto", dgInteger, False, 500, 0, True, True, False
            ...
            .Add "OgniNumeroMesi", "Ogni n° giorni", dgInteger, True, 1000, 0, True, True, False
    ...
    LabelLink2.IDFunction = GET_FUNZIONE(GET_TIPO_OGGETTO("RV_POTipoContrattoCond"))
End Sub
...
Private Sub chkFestivo_Click()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cmdCondizioniGenerali_Click()
On Error GoTo ERR_cmdCondizioniGenerali_Click
    ...
    SaveSetting REGISTRY_KEY, App.EXEName, "IDField", fnNotNullN(fnNotNullN(m_Document(m_Document.PrimaryKey).Value))
    
    
    SaveSetting REGISTRY_KEY, "RV_POTipoContrattoCond", "Client", App.EXEName

    Shell App.Path & "\RV_POTipoContrattoCond.exe"
...
Private Sub cmdEliminaServizio_Click()
    ...
    If MsgBox("Sei sicuro di eliminare il servizio?", vbCritical, "Eliminazione dati") = vbNo Then
        Exit Sub
    End If
...
If Me.CDArticoloEcc.KeyFieldID = 0 Then
...
m_DocumentsLink1("IDArticolo").Value = Me.CDArticoloEcc.KeyFieldID
...
ERR_cmdSalvaEcc_Click:
    MsgBox Err.Description, vbCritical, "ERR_cmdSalvaEcc_Click"
End Sub
...
Private Sub cmdSalvaServizio_Click()
    ...
    m_DocumentsLink("IDArticolo").Value = Me.CDServizio.KeyFieldID
    m_DocumentsLink("IDRV_POCriterioRicorrenza").Value = Me.cboCriterioRicorrenza.CurrentID
    m_DocumentsLink("OgniNumeroGiorni").Value = Me.txtOgniNumeroGiorni.Value
    m_DocumentsLink("OgniNumeroMesi").Value = Me.txtOgniNumeroMesi.Value
    m_DocumentsLink("OgniNumeroSettimane").Value = Me.txtOgniNumeroSettimane.Value
    m_DocumentsLink("IDRV_POTipoDataInizioRicorrenza").Value = Me.cboTipoDataInizioRic.CurrentID
    m_DocumentsLink("GiornoInizioRicorrenza").Value = Me.txtGiornoFissoInizioRic.Value
    m_DocumentsLink("MeseInizioRicorrenza").Value = Me.txtMeseFissoInizioRic.Value
    m_DocumentsLink("IDRV_POTipoDataFineRicorrenza").Value = Me.cboTipoDataFineRic.CurrentID
    m_DocumentsLink("GiornoFineRicorrenza").Value = Me.txtGiornoFissoFineRic.Value
    m_DocumentsLink("MeseFineRicorrenza").Value = Me.txtMeseFissoFineRic.Value
    m_DocumentsLink("NumeroRicorrenze").Value = Me.txtNumeroRicorrenze.Value
    m_DocumentsLink("IDRV_POTipoAnnoInizioRicorrenza").Value = Me.cboTipoAnnoInizioRicorr.CurrentID
    m_DocumentsLink("IDRV_POTipoAnnoFineRicorrenza").Value = Me.cboTipoAnnoFineRicorr.CurrentID
    m_DocumentsLink.Save
    
    m_DocumentsLink.Move Me.GrigliaServizi.ListIndex - 1
...
Private Sub lblPianoDeiConti_Click()
...
'            End If
   ...
   'If Me.GrigliaFasiIntervento.ColumnsHeader.Count > 0 Then
       On Error Resume Next
        ...
        Set Me.GrigliaServizi.Recordset = m_Document.DocumentsLinks.Item(m_DocumentsLink.TableName).Data
        Set Me.GrigliaEccezioni.Recordset = m_Document.DocumentsLinks.Item(m_DocumentsLink1.TableName).Data
    'End If

    If Not (m_Document.EOF Or m_Document.BOF) Then
        Link_ContoPDC = IIf(IsNull(m_Document("IDContoPDC")), 0, m_Document("IDContoPDC"))
    Else
        Link_ContoPDC = 0
    End If
    'rif11 begin
...
Private Sub m_DocumentsLink_OnReposition()
    ...
    If Not (m_DocumentsLink.BOF And m_DocumentsLink.EOF) Then
        ...
        Me.CDServizio.Load fnNotNullN(m_DocumentsLink("IDArticolo").Value)
        Me.cboCriterioRicorrenza.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POCriterioRicorrenza").Value)
        Me.txtOgniNumeroGiorni.Value = fnNotNullN(m_DocumentsLink("OgniNumeroGiorni").Value)
        Me.txtOgniNumeroMesi.Value = fnNotNullN(m_DocumentsLink("OgniNumeroMesi").Value)
        Me.txtOgniNumeroSettimane.Value = fnNotNullN(m_DocumentsLink("OgniNumeroSettimane").Value)
        Me.cboTipoDataInizioRic.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POTipoDataInizioRicorrenza").Value)
        Me.txtGiornoFissoInizioRic.Value = fnNotNullN(m_DocumentsLink("GiornoInizioRicorrenza").Value)
        Me.txtMeseFissoInizioRic.Value = fnNotNullN(m_DocumentsLink("MeseInizioRicorrenza").Value)
        Me.cboTipoDataFineRic.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POTipoDataFineRicorrenza").Value)
        Me.txtGiornoFissoFineRic.Value = fnNotNullN(m_DocumentsLink("GiornoFineRicorrenza").Value)
        Me.txtMeseFissoFineRic.Value = fnNotNullN(m_DocumentsLink("MeseFineRicorrenza").Value)
        Me.txtNumeroRicorrenze.Value = fnNotNullN(m_DocumentsLink("NumeroRicorrenze").Value)
        Me.cboTipoAnnoInizioRicorr.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POTipoAnnoInizioRicorrenza").Value)
        Me.cboTipoAnnoFineRicorr.WriteOn fnNotNullN(m_DocumentsLink("IDRV_POTipoAnnoFineRicorrenza").Value)
...
If Not (m_DocumentsLink1.BOF And m_DocumentsLink1.EOF) Then
    ...
    Me.CDArticoloEcc.Load fnNotNullN(m_DocumentsLink1("IDArticolo").Value)
...
Private Sub txtCodiceConto_LostFocus()
    If Len(Me.txtCodiceConto.Text) > 0 Then
        lblPianoDeiConti_Click
    End If
End Sub

Private Sub txtDescrizioneAggiuntiva_Change()
    If Not (BrwMain.Visible) Then Change
...
Private Sub txtTipoContratto_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
