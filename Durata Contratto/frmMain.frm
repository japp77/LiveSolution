      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtDurataContratto 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "DurataContratto"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtDurataContratto
    Field.Name = "DurataContratto"
    Field.Visible = True
    Me.txtDurataContratto.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("DurataContratto", "Durata contratto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtDurataContratto_Change()
