      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtMarcaProdotto 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "MarcaProdotto"
...
Private Function PermissionToSave() As Boolean
    ...
    If Len(Trim(Me.txtMarcaProdotto.Text)) = 0 Then
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtMarcaProdotto
    Field.Name = "MarcaProdotto"
    Field.Visible = True
    Me.txtMarcaProdotto.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("MarcaProdotto", "Marca prodotto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtMarcaProdotto_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
...
sSQL = "SELECT IDRV_POMarcaProdotto FROM RV_POMarcaProdotto "
sSQL = sSQL & " WHERE MarcaProdotto=" & fnNormString(Me.txtMarcaProdotto.Text)
sSQL = sSQL & " AND IDRV_POMarcaProdotto<>" & fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
