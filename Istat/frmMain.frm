         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Begin VB.TextBox txtIstat 
                  ...
                  Width           =   6855
               End
               Begin DMTEDITNUMLib.dmtNumber txtPercentuale 
                  Height          =   315
                  Left            =   1800
                  TabIndex        =   3
                  Top             =   1200
...
Private Const CAMPO_PER_CAPTION = "Istat"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtIstat
    Field.Name = "Istat"
    Field.Visible = True
    Me.txtIstat.Tag = Field.Name
    ...
    'Anno
    Set Field = New FormField
    Set Field.Control = Me.txtAnno
    Field.Name = "Anno"
    Field.Visible = True
    Me.txtAnno.Tag = Field.Name
    m_FormFields.Add Field

    'Percentuale
    Set Field = New FormField
    Set Field.Control = Me.txtPercentuale
    Field.Name = "Percentuale"
    Field.Visible = True
    Me.txtPercentuale.Tag = Field.Name
    m_FormFields.Add Field
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Istat", "Istat", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("Mese", "Mese", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("Anno", "Anno", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtPercentuale_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
