      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin VB.TextBox txtTipoDurataAssistenza 
                  Height          =   285
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
               ...
               End
               Begin VB.Label Label1 
                  Caption         =   "Tipo durata assistenza"
                  Height          =   255
                  Index           =   0
                  Left            =   120
                  TabIndex        =   12
...
Private Const CAMPO_PER_CAPTION = "TipoDurataAssistenza"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoDurataAssistenza
    Field.Name = "TipoDurataAssistenza"
    Field.Visible = True
    Me.txtTipoDurataAssistenza.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoDurataAssistenza", "Tipo durata assistenza", m_DocType.TableName, False, False, False, dgCondTypeText)
