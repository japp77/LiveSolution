...
Private Const CAMPO_PER_CAPTION = "TipoManutenzione"
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Tipo manutenzione", "TipoManutenzione", m_DocType.TableName, False, False, False, dgCondTypeText)
