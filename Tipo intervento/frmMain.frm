...
Private Const CAMPO_PER_CAPTION = "TipoFaseIntervento"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoIntervento
    Field.Name = "TipoFaseIntervento"
    Field.Visible = True
    Me.txtTipoIntervento.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoFaseIntervento", "Tipo intervento", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtTipoIntervento_Change()
If Not (BrwMain.Visible) Then Change
