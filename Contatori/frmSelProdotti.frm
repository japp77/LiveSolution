...
sSQL = sSQL & "WHERE IDRV_POContatoreProdotto=" & LINK_CONTATORE
Cn.Execute sSQL
...
While Not rsGriglia.EOF
    ...
    rs.AddNew
        ...
        rs!IDRV_POProdotto = rsGriglia!IDRV_POProdotto
        rs!IDRV_POContatoreProdotto = LINK_CONTATORE
    rs.Update
...
While Not rs.EOF
    If Avvia = True Then
        ...
        rsGriglia.AddNew
            ...
            rsGriglia!Riporta = GET_ESISTENZA_PRODOTTO(LINK_CONTATORE, fnNotNullN(rs!IDRV_POProdotto))
