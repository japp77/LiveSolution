      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8655
               Begin DMTDataCmb.DMTCombo cboUMCont 
                  Height          =   315
                  Left            =   6960
                  TabIndex        =   2
                  Top             =   600
                  ...
                  EndProperty
               End
               Begin DMTLblLinkCtl.LabelLink lblUMContatore 
                  Height          =   255
                  Left            =   6960
                  TabIndex        =   18
                  Top             =   360
                  ...
                  Name            =   "LabelLink"
               End
               Begin VB.CommandButton cmdProdotti 
                  Caption         =   "GESTIONE PRODOTTI"
                  BeginProperty Font 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDArticolo 
                  ...
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":47AAA
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               End
               Begin DmtCodDescCtl.DmtCodDesc CDArticoloServ 
                  Height          =   735
                  Left            =   120
                  TabIndex        =   4
                  Top             =   1920
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":47B53
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":47BBF
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
...
Private Const CAMPO_PER_CAPTION = "Codice"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtCodice
    Field.Name = "Codice"
    Field.Visible = True
    Me.txtCodice.Tag = Field.Name
    ...
    'IDArticoloFatturazione
    Set Field = New FormField
    Set Field.Control = Me.CDArticolo
    Field.Name = "IDArticoloFatturazione"
    Field.Visible = True
    Me.CDArticolo.Tag = Field.Name
    m_FormFields.Add Field

    'IDArticoloServizioIntervento
    Set Field = New FormField
    Set Field.Control = Me.CDArticoloServ
    Field.Name = "IDArticoloServizioIntervento"
    Field.Visible = True
    Me.CDArticoloServ.Tag = Field.Name
    m_FormFields.Add Field
    
    
    'IDRV_POUMContatore
    Set Field = New FormField
    Set Field.Control = Me.cboUMCont
    Field.Name = "IDRV_POUMContatore"
    Field.Visible = True
    Me.cboUMCont.Tag = Field.Name
    m_FormFields.Add Field
End Sub
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("Codice", "Codice", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("Descrizione", "Descrizione", m_DocType.TableName, False, False, False, dgCondTypeText)
                
    Set Cond = BrwMain.Conditions.Add("CodiceArticoloFatt", "Codice articolo fatt.", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("ArticoloFatt", "Articolo fatt.", m_DocType.TableName, False, False, False, dgCondTypeText)
    
    Set Cond = BrwMain.Conditions.Add("CodiceArticoloServ", "Codice articolo serv.", m_DocType.TableName, False, False, False, dgCondTypeText)
    Set Cond = BrwMain.Conditions.Add("ArticoloServ", "Articolo serv.", m_DocType.TableName, False, False, False, dgCondTypeText)
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    With Me.cboUMCont
        ...
        .AddFieldKey "IDRV_POUMContatore"
        .DisplayField = "Descrizione"
        .SQL = "SELECT * FROM RV_POUMContatore"
        .Fill
    End With

    Set Me.lblUMContatore.Application = TheApp
    Me.lblUMContatore.WindowHandleClient = Me.hwnd
    Me.lblUMContatore.PopMenuItems("Mnu_SearchObject").Enabled = False
    Me.lblUMContatore.IDFunction = GET_FUNZIONE(GET_TIPO_OGGETTO("RV_POUMContatore"))
...
Private Sub CDArticoloServ_ChangeElement()
    If Not (BrwMain.Visible) Then Change
End Sub
Private Sub cmdProdotti_Click()

    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then Exit Sub
    
    LINK_CONTATORE = fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
Private Sub lblUMContatore_AfterRunServerApplication(ByVal lIDResultKey As Long)
    
    If lIDResultKey = 0 Then Exit Sub
    ...
    Me.cboUMCont.WriteOn lIDResultKey
    
End Sub

Private Sub lblUMContatore_BeforeRunServerApplication()
    Me.lblUMContatore.IDReturn = Me.cboUMCont.CurrentID
...
If Not (BrwMain.Visible) Then Change
End Sub
Private Sub GET_GRIGLIA(ID As Long)
...
Dim cl As dgColumnHeader
    ...
    sSQL = sSQL & "WHERE IDRV_POContatoreProdotto=" & ID
    ...
    With Me.Griglia
        ...
        .ColumnsHeader.Clear
            ...
            .ColumnsHeader.Add "DescrizioneProdotto", "Prodotto", dgchar, True, 2500, dgAlignleft
            ...
            .ColumnsHeader.Add "CodiceContatore", "Codice contatore", dgchar, False, 2500, dgAlignleft
            .ColumnsHeader.Add "DescrizioneContatore", "Descr. contatore", dgchar, False, 2500, dgAlignleft
