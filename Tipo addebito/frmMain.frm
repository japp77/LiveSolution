...
Private Const CAMPO_PER_CAPTION = "TipoAddebito"
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoAddebito
    Field.Name = "TipoAddebito"
    Field.Visible = True
    Me.txtTipoAddebito.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoAddebito", "Tipo addebito", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtTipoAddebito_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
