...
Dim pth As String
    ...
    SetKeyValue HKEY_CURRENT_USER, "SOFTWARE\MICROSOFT\WINDOWS\CURRENTVERSION\RUN\", NomeAvvio, pth, REG_SZ

End Sub
Public Sub DontShowAtStartup(yourexe$)
    DeleteValue HKEY_LOCAL_MACHINE, "SOFTWARE\MICROSOFT\WINDOWS\CURRENTVERSION\RUN\", yourexe$
    DeleteValue HKEY_CURRENT_USER, "SOFTWARE\MICROSOFT\WINDOWS\CURRENTVERSION\RUN\", yourexe$
End Sub
