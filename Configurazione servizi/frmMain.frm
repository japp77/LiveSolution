      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   120
               Width           =   10935
               Begin DMTEDITNUMLib.dmtNumber txtNumeroTicket 
                  Height          =   315
                  Left            =   9240
                  TabIndex        =   2
                  Top             =   480
               ...
               Begin TabDlg.SSTab SSTab1 
                  ...
                  TabsPerRow      =   1
                  TabHeight       =   520
                  TabCaption(0)   =   "Ricorrenze"
                  TabPicture(0)   =   "frmMain.frx":479EA
                  Tab(0).ControlEnabled=   -1  'True
                  Tab(0).Control(0)=   "Frame2"
                  Tab(0).Control(0).Enabled=   0   'False
                  Tab(0).Control(1)=   "chkGestioneRicorrenze"
                  Tab(0).Control(1).Enabled=   0   'False
                  Tab(0).ControlCount=   2
                  Begin VB.CheckBox chkGestioneRicorrenze 
                     Caption         =   "Gestione ricorrenze"
                     Height          =   195
                     Left            =   240
                     TabIndex        =   6
                     Top             =   480
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDArticolo 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":47A55
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":47AAC
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               Begin DMTDataCmb.DMTCombo cboTipoProdotto 
                  ...
                  EndProperty
               End
               Begin DMTDataCmb.DMTCombo cboGruppoEquivalenza 
                  Height          =   315
                  Left            =   6240
                  TabIndex        =   5
                  Top             =   1200
                  ...
                  EndProperty
               End
               Begin DMTEDITNUMLib.dmtNumber txtTempoEffettivo 
                  Height          =   315
                  Left            =   9240
                  TabIndex        =   49
                  Top             =   1200
               ...
               Begin VB.Label Label2 
                  Caption         =   "Tempo stimato"
                  Height          =   255
                  Index           =   5
                  Left            =   9240
                  TabIndex        =   50
                  ToolTipText     =   "Tempo stimato espresso in minuti"
                  Top             =   960
                  Width           =   1575
               End
               Begin VB.Label Label2 
...
Private Const CAMPO_PER_CAPTION = "Articolo"
...
Private Function PermissionToSave() As Boolean
    ...
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then
        If GET_ESISTENZA_CONFIGURAZIONE(Me.CDArticolo.KeyFieldID) = True Then
...
'If Me.chkGestioneRicorrenze.Value = vbChecked Then
...
Private Sub CreateFormFields()
    ...
    Set Field = New FormField
    Set Field.Control = Me.cboCriterioRicorrenza
    Field.Name = "IDRV_POCriterioRicorrenza"
    Field.Visible = True
    Me.cboCriterioRicorrenza.Tag = Field.Name
    m_FormFields.Add Field

    'Ogni numero giorni
    Set Field = New FormField
    Set Field.Control = Me.txtOgniNumeroGiorni
    Field.Name = "OgniNumeroGiorni"
    Field.Visible = True
    Me.txtOgniNumeroGiorni.Tag = Field.Name
    m_FormFields.Add Field

    'Ogni numero mesi
    Set Field = New FormField
    Set Field.Control = Me.txtOgniNumeroMesi
    Field.Name = "OgniNumeroMesi"
    Field.Visible = True
    Me.txtOgniNumeroMesi.Tag = Field.Name
    m_FormFields.Add Field

    'Ogni numero settimane
    Set Field = New FormField
    Set Field.Control = Me.txtOgniNumeroSettimane
    Field.Name = "OgniNumeroSettimane"
    Field.Visible = True
    Me.txtOgniNumeroSettimane.Tag = Field.Name
    m_FormFields.Add Field


    'Tipo data inizio ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.cboTipoDataInizioRic
    Field.Name = "IDRV_POTipoDataInizioRicorrenza"
    Field.Visible = True
    Me.cboTipoDataInizioRic.Tag = Field.Name
    m_FormFields.Add Field

    'Giorno fisso di inizio ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.txtGiornoFissoInizioRic
    Field.Name = "GiornoInizioRicorrenza"
    Field.Visible = True
    Me.txtGiornoFissoInizioRic.Tag = Field.Name
    m_FormFields.Add Field

    'Mese fisso di inizio ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.txtMeseFissoInizioRic
    Field.Name = "MeseInizioRicorrenza"
    Field.Visible = True
    Me.txtMeseFissoInizioRic.Tag = Field.Name
    m_FormFields.Add Field

    'Tipo data fine ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.cboTipoDataFineRic
    Field.Name = "IDRV_POTipoDataFineRicorrenza"
    Field.Visible = True
    Me.cboTipoDataFineRic.Tag = Field.Name
    m_FormFields.Add Field

    'Giorno fisso di fine ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.txtGiornoFissoFineRic
    Field.Name = "GiornoFineRicorrenza"
    Field.Visible = True
    Me.txtGiornoFissoFineRic.Tag = Field.Name
    m_FormFields.Add Field

    'Mese fisso di fine ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.txtMeseFissoFineRic
    Field.Name = "MeseFineRicorrenza"
    Field.Visible = True
    Me.txtMeseFissoFineRic.Tag = Field.Name
    m_FormFields.Add Field

    'Numero ricorrenza
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroRicorrenze
    Field.Name = "NumeroRicorrenze"
    Field.Visible = True
    Me.txtNumeroRicorrenze.Tag = Field.Name
    m_FormFields.Add Field

    'NumeroTicket
    Set Field = New FormField
    Set Field.Control = Me.txtNumeroTicket
    Field.Name = "NumeroTicket"
    Field.Visible = True
    Me.txtNumeroTicket.Tag = Field.Name
    m_FormFields.Add Field

    'Gestione ricorrenze
    Set Field = New FormField
    Set Field.Control = Me.chkGestioneRicorrenze
    Field.Name = "GestioneRicorrenze"
    Field.Visible = True
    Me.chkGestioneRicorrenze.Tag = Field.Name
    m_FormFields.Add Field

    'Tempo effettivo
    Set Field = New FormField
    Set Field.Control = Me.txtTempoEffettivo
    Field.Name = "TempoEffettivo"
    Field.Visible = True
    Me.txtTempoEffettivo.Tag = Field.Name
    m_FormFields.Add Field

    'Anno inizio decorrenza
    Set Field = New FormField
    Set Field.Control = Me.cboTipoAnnoInizioRicorr
    Field.Name = "IDRV_POTipoAnnoInizioRicorrenza"
    Field.Visible = True
    Me.cboTipoAnnoInizioRicorr.Tag = Field.Name
    m_FormFields.Add Field

    'Anno fine decorrenza
    Set Field = New FormField
    Set Field.Control = Me.cboTipoAnnoFineRicorr
    Field.Name = "IDRV_POTipoAnnoFineRicorrenza"
    Field.Visible = True
    Me.cboTipoAnnoFineRicorr.Tag = Field.Name
    m_FormFields.Add Field
...
Dim Cond As DmtGridCtl.dgCondition
    ...
    BrwMain.Conditions("Group1").IsHeader = True
        ...
        Set Cond = BrwMain.Conditions.Add("Articolo", "Articolo", m_DocType.TableName, False, False, False, dgCondTypeText)
        
        Set Cond = BrwMain.Conditions.Add("IDUnitaDiMisuraVendita", "Unità di misura", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM UnitaDiMisura ORDER BY UnitaDiMisura"
            Cond.DisplayField = "UnitaDiMisura"
            Cond.KeyField = "IDUnitaDiMisura"
        ...
        Set Cond = BrwMain.Conditions.Add("IDCategoriaMerceologica", "Categoria merceologica", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM CategoriaMerceologica ORDER BY CategoriaMerceologica"
        ...
        Set Cond = BrwMain.Conditions.Add("IDTipoProdotto", "Tipo prodotto", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM TipoProdotto WHERE IDAzienda=" & TheApp.IDFirm & " ORDER BY TipoProdotto"
            Cond.DisplayField = "TipoProdotto"
            Cond.KeyField = "IDTipoProdotto"
        
        Set Cond = BrwMain.Conditions.Add("IDGruppoEquivalenzaArticolo", "Gruppo Equivalenza", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM GruppoEquivalenzaArticolo WHERE IDAzienda=" & TheApp.IDFirm & " ORDER BY GruppoEquivalenzaArticolo"
            Cond.DisplayField = "GruppoEquivalenzaArticolo"
            Cond.KeyField = "IDGruppoEquivalenzaArticolo"

    BrwMain.Conditions.Add "Group2", "CRITERI DI RICORRENZA", ""
    BrwMain.Conditions("Group2").IsHeader = True
        
        Set Cond = BrwMain.Conditions.Add("GestioneRicorrenze", "Gestione ricorrenze", m_DocType.TableName, False, False, , dgCondTypeBoolean)
      
        
        Set Cond = BrwMain.Conditions.Add("IDRV_POCriterioRicorrenza", "Criterio di ricorrenza", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM RV_POCriterioRicorrenza ORDER BY IDRV_POCriterioRicorrenza"
            Cond.DisplayField = "CriterioRicorrenza"
            Cond.KeyField = "IDRV_POCriterioRicorrenza"
        
        Set Cond = BrwMain.Conditions.Add("OgniNumeroGiorni", "Ogni numero giorni", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        Set Cond = BrwMain.Conditions.Add("OgniNumeroMesi", "Ogni numero mesi", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        Set Cond = BrwMain.Conditions.Add("OgniNumeroSettimane", "Ogni numero mesi", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        
        Set Cond = BrwMain.Conditions.Add("IDRV_POTipoDataInizioRicorrenza", "Tipo data inizio ricorrenza", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM RV_POTipoDataInizioRicorrenza ORDER BY IDRV_POTipoDataInizioRicorrenza"
            Cond.DisplayField = "TipoDataInizioRicorrenza"
            Cond.KeyField = "IDRV_POTipoDataInizioRicorrenza"
        Set Cond = BrwMain.Conditions.Add("GiorniInizioRicorrenza", "Giorno inizio ricorrenza", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        Set Cond = BrwMain.Conditions.Add("MeseInizioRicorrenza", "Mese inizio ricorrenza", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        
        
        Set Cond = BrwMain.Conditions.Add("IDRV_POTipoDataFineRicorrenza", "Tipo data fine ricorrenza", m_DocType.TableName, False, False, , dgCondTypeComboDB)
            Cond.RecordSource = "SELECT * FROM RV_POTipoDataFineRicorrenza ORDER BY IDRV_POTipoDataFineRicorrenza"
            Cond.DisplayField = "TipoDataFineRicorrenza"
            Cond.KeyField = "IDRV_POTipoDataFineRicorrenza"
        
        Set Cond = BrwMain.Conditions.Add("GiorniFineRicorrenza", "Giorno fine ricorrenza", m_DocType.TableName, False, False, False, dgCondTypeNumber)
        Set Cond = BrwMain.Conditions.Add("MeseFineRicorrenza", "Mese fine ricorrenza", m_DocType.TableName, False, False, False, dgCondTypeNumber)
       
       Set Cond = BrwMain.Conditions.Add("NumeroRicorrenze", "Numero di ricorrenze", m_DocType.TableName, False, False, False, dgCondTypeNumber)
...
'SETTARE LE GRIGLIE DEI SOTTODOCUMENTI
    ...
    With Me.cboCategoriaMerceologica
        ...
        .SQL = "SELECT * FROM CategoriaMerceologica ORDER BY CategoriaMerceologica"
        .Fill
    End With
    ...
    With Me.cboTipoProdotto
        ...
        .SQL = .SQL & " ORDER BY TipoProdotto"
        .Fill
    End With
    
    'Gruppo equivalenza articolo
    With Me.cboGruppoEquivalenza
        Set .Database = m_App.Database.Connection
        .AddFieldKey "IDGruppoEquivalenzaArticolo"
        .DisplayField = "GruppoEquivalenzaArticolo"
        .SQL = "SELECT * FROM GruppoEquivalenzaArticolo"
        .SQL = .SQL & " WHERE IDAzienda=" & TheApp.IDFirm
        .SQL = .SQL & " ORDER BY GruppoEquivalenzaArticolo"
        .Fill
    End With
...
Private Sub cboTipoAnnoFineRicorr_Click()
If Not (BrwMain.Visible) Then Change
End Sub

Private Sub cboTipoAnnoInizioRicorr_Click()
If Not (BrwMain.Visible) Then Change
End Sub
...
If rs.EOF Then
    ...
    Me.cboTipoProdotto.WriteOn 0
    Me.cboCategoriaMerceologica.WriteOn 0
    Me.cboGruppoEquivalenza.WriteOn 0
Else
    Me.cboUnitaDiMisura.WriteOn fnNotNullN(rs("IDUnitaDiMisuraVendita").Value)
    Me.cboTipoProdotto.WriteOn fnNotNullN(rs("IDTipoProdotto").Value)
    Me.cboCategoriaMerceologica.WriteOn fnNotNullN(rs("IDCategoriaMerceologica").Value)
    Me.cboGruppoEquivalenza.WriteOn fnNotNullN(rs("IDGruppoEquivalenzaArticolo").Value)
End If
...
Private Sub chkGestioneRicorrenze_Click()
    If Me.chkGestioneRicorrenze.Value = vbChecked Then
...
Private Sub txtGiornoFissoFineRic_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtGiornoFissoInizioRic_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtMeseFissoFineRic_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtMeseFissoInizioRic_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtNumeroRicorrenze_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtNumeroTicket_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtOgniNumeroGiorni_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtOgniNumeroMesi_Change()
    If Not (BrwMain.Visible) Then Change

End Sub

Private Sub txtOgniNumeroSettimane_Change()
    If Not (BrwMain.Visible) Then Change

End Sub
Private Function GET_ESISTENZA_CONFIGURAZIONE(IDArticolo As Long) As Boolean
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT IDArticolo FROM RV_POConfigurazioneServizio "
...
Private Sub txtTempoEffettivo_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
