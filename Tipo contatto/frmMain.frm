   ...
   Begin ActiveBar3LibraryCtl.ActiveBar3 BarMenu 
      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Top             =   120
            Width           =   6360
            Begin VB.TextBox txtTipoContatto 
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
...
Private Const CAMPO_PER_CAPTION = "TipoContatto"
...
Private Function GetDescription4StatusBar(ByVal sToolName As String) As String
    ...
    Select Case sToolName
        ...
        Case "Help" 'toolbar e menu
            sStr = gResource.GetMessage(IDS_SB_HELP)
            
        Case "Mnu_HelpOnLine"
            sStr = gResource.GetMessage(IDS_SB_SUMMARY)
            
        Case "Mnu_Summary"
            sStr = gResource.GetMessage(IDS_SB_SHOW_HELPINDEX)
            
        Case "Mnu_FastHelp"
            sStr = gResource.GetMessage(IDS_SB_CONTEXT_HELP)
        ...
        Case "Mnu_ChoiceAssistant"
            sStr = gResource.GetMessage(IDS_SB_SELECT_ASSISTANT)
                    
        Case "Mnu_ViewAssistant"
            sStr = gResource.GetMessage(IDS_SB_SHOW_HIDE_ASSISTANT)
            
        Case "Mnu_ViewAnimation"
            sStr = gResource.GetMessage(IDS_SB_SHOW_ANIMATION)
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoContatto
    Field.Name = "TipoContatto"
    Field.Visible = True
    Me.txtTipoContatto.Tag = Field.Name
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoContatto", "Tipo contatto", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub txtTipoContatto_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
