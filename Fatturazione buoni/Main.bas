...
Public LINK_TECNICO_OPERATIVO As Long
Public NUMERO_BUONO As Long
...
Public LINK_CARICO_MAGAZZINO As Long


''''''''''''''VARIABILE RECORDSET GRIGLIA BUONI DA FATTURARE'''''''''''''''''
Public rsFiltro As ADODB.Recordset
Public rsnew As ADODB.Recordset
Public rsAna As ADODB.Recordset
Public rsBuoni As ADODB.Recordset
Public rsAnaFatt As ADODB.Recordset
Public rsBuoniFatt As ADODB.Recordset

Public rsAnaVis As ADODB.Recordset
Public rsBuoniVis As ADODB.Recordset



Public ArrayAna(100) As Long
Public NUMERO_ANAGRAFICHE As Long
Public NUMERO_ADDEBITI_DA_FATTURARE As Long

Public FLAG_RAGGR_ALTRA_DEST As Long
Public FLAG_RAGGR_CORPO_ALTRA_DEST As Long
Public FLAG_RAGGR_CORPO_INT As Long

Public FLAG_SOVRAS_DESCRIZIONE As Long
...
End Sub
Public Function fncEsercizio() As Long
    fncEsercizio = 0
    Dim sSQL As String
    Dim rs As DmtOleDbLib.adoResultset
