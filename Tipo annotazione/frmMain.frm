      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame Frame1 
               ...
               Top             =   0
               Width           =   8055
               Begin VB.CheckBox chkGrassetto 
                  Caption         =   "Grassetto"
                  Height          =   195
                  Left            =   5040
                  TabIndex        =   20
                  ...
                  Width           =   1815
               End
               Begin VB.CommandButton cmdEliminaColoreTesto 
                  Height          =   285
                  Left            =   6480
                  ...
                  TabIndex        =   8
                  TabStop         =   0   'False
                  ToolTipText     =   "Elimina il colore del testo"
                  Top             =   300
                  Width           =   375
               End
               Begin VB.CommandButton cmdColoreTesto 
                  Height          =   285
                  Left            =   6120
                  Picture         =   "frmMain.frx":0A64
                  Style           =   1  'Graphical
                  TabIndex        =   7
                  TabStop         =   0   'False
                  ToolTipText     =   "Imposta il colore del testo"
                  Top             =   300
                  Width           =   375
               End
               Begin VB.CommandButton cmdEliminaSfondo 
                  Height          =   285
                  Left            =   5400
                  ...
                  TabIndex        =   6
                  TabStop         =   0   'False
                  ToolTipText     =   "Elimina il colore di sfondo"
                  Top             =   300
                  Width           =   375
               End
               Begin VB.CommandButton cmdSfondo 
                  Height          =   285
                  Left            =   5040
                  Picture         =   "frmMain.frx":1578
                  Style           =   1  'Graphical
                  TabIndex        =   5
                  TabStop         =   0   'False
                  ToolTipText     =   "Imposta il colore di sfondo"
                  Top             =   300
                  Width           =   375
               End
               Begin VB.TextBox txtConfigurazione 
                  Alignment       =   2  'Center
                  Height          =   315
                  Left            =   5040
                  Locked          =   -1  'True
                  ...
                  Width           =   1815
               End
               Begin VB.TextBox txtTipoAnnotazione 
                  Height          =   315
                  Left            =   120
                  TabIndex        =   0
                  Top             =   600
                  Width           =   3615
               End
               Begin DMTEDITNUMLib.dmtNumber txtColoreTesto 
                  Height          =   285
                  Left            =   6120
                  TabIndex        =   4
                  TabStop         =   0   'False
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtColoreSfondo 
                  Height          =   285
                  Left            =   5040
                  TabIndex        =   3
                  TabStop         =   0   'False
                  ...
                  AllowEmpty      =   0   'False
               End
               Begin DMTEDITNUMLib.dmtNumber txtImportanza 
                  Height          =   315
                  Left            =   3840
                  TabIndex        =   1
                  Top             =   600
...
Private Const CAMPO_PER_CAPTION = "TipoAnnotazioneCliente"
...
'    m_Semaphore.SetObjectAction m_DocType.ID, SemAllObjects, SemInsertAction
    ...
    Me.txtColoreSfondo.Value = -1
    Me.txtColoreTesto.Value = -1
    GET_CONFIGURAZIONE_COLORE Me.txtColoreSfondo.Value, Me.txtColoreTesto.Value
    'Refresh delle variabili di stato
    m_Search = False
    m_Changed = False
    m_Saved = False
...
Private Sub CreateFormFields()
    ...
    Set Field.Control = Me.txtTipoAnnotazione
    Field.Name = "TipoAnnotazioneCliente"
    Field.Visible = True
    Me.txtTipoAnnotazione.Tag = Field.Name
    m_FormFields.Add Field
    
    'Importanza
    Set Field = New FormField
    Set Field.Control = Me.txtImportanza
    Field.Name = "Importanza"
    Field.Visible = True
    Me.txtImportanza.Tag = Field.Name
    m_FormFields.Add Field

    'Colore sfondo
    Set Field = New FormField
    Set Field.Control = Me.txtColoreSfondo
    Field.Name = "ColoreSfondo"
    Field.Visible = True
    Me.txtColoreSfondo.Tag = Field.Name
    m_FormFields.Add Field

    'Colore testo
    Set Field = New FormField
    Set Field.Control = Me.txtColoreTesto
    Field.Name = "ColoreTesto"
    Field.Visible = True
    Me.txtColoreTesto.Tag = Field.Name
    m_FormFields.Add Field

    'Grassetto
    Set Field = New FormField
    Set Field.Control = Me.chkGrassetto
    Field.Name = "Grassetto"
    Field.Visible = True
    Me.chkGrassetto.Tag = Field.Name
    m_FormFields.Add Field
End Sub
...
Private Sub CreateBrowserConditions()
    ...
    Set Cond = BrwMain.Conditions.Add("TipoAnnotazioneCliente", "Tipo annotazione", m_DocType.TableName, False, False, False, dgCondTypeText)
...
Private Sub chkGrassetto_Click()
    If Not (BrwMain.Visible) Then Change
    
    GET_CONFIGURAZIONE_COLORE Me.txtColoreSfondo.Value, Me.txtColoreTesto.Value
End Sub

Private Sub cmdColoreTesto_Click()
Dim Colore As Long
    
    Colore = ShowColorDialog(Me.hwnd, True, Me.txtColoreTesto.Value)
    If Colore >= 0 Then
        Me.txtColoreTesto.Value = Colore
    End If

    GET_CONFIGURAZIONE_COLORE Me.txtColoreSfondo.Value, Me.txtColoreTesto.Value
End Sub

Private Sub cmdEliminaColoreTesto_Click()
    Me.txtColoreTesto.Value = -1
...
Private Sub cmdEliminaSfondo_Click()
    Me.txtColoreSfondo.Value = -1
...
Dim Colore As Long
    ...
    Colore = ShowColorDialog(Me.hwnd, True, Me.txtColoreSfondo.Value)
    If Colore >= 0 Then
        Me.txtColoreSfondo.Value = Colore
    End If
    GET_CONFIGURAZIONE_COLORE Me.txtColoreSfondo.Value, Me.txtColoreTesto.Value
End Sub
...
Private Sub GET_CONFIGURAZIONE_COLORE(ColoreSfondo As Long, ColoreTesto As Long)

If ColoreSfondo = -1 Then
    Me.txtConfigurazione.BackColor = vbWhite
Else
    Me.txtConfigurazione.BackColor = ColoreSfondo
End If
If ColoreTesto = -1 Then
    Me.txtConfigurazione.ForeColor = vbBlack
Else
    Me.txtConfigurazione.ForeColor = ColoreTesto
End If

If Me.chkGrassetto.Value = Checked Then
    Me.txtConfigurazione.FontBold = True
Else
    Me.txtConfigurazione.FontBold = False
End If

End Sub

Private Sub txtColoreSfondo_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtColoreTesto_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtImportanza_Change()
    If Not (BrwMain.Visible) Then Change
End Sub

Private Sub txtTipoAnnotazione_Change()
    If Not (BrwMain.Visible) Then Change
End Sub
